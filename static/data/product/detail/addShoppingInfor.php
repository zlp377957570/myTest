...
// print_r($set_meal);
// echo '>>>>>>>>>>>>>>>>>>>>>';
$sql = "select p_name,d_style_src,d_style_version,d_style_color,d_style_price,d_style_original_price,d_style_MaxCount from mimi_details_style where p_name = '$name' and d_style_version = '$version' and d_style_color = '$color' and d_style_size = '$size' and p_set_meal = '$set_meal'";

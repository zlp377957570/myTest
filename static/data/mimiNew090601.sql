...
CREATE TABLE `mimi_details_review` (
  ...
  `d_review_replyList` varchar(4096) NOT NULL
...
INSERT INTO `mimi_details_review` (`d_review_id`, `p_name`, `d_review_icon`, `d_review_name`, `d_review_time`, `d_review_zan`, `d_review_text`, `d_review_imgList`, `d_review_replyList`) VALUES
(1, '小米9', 'https://s1.mi-img.com/mfsv2/avatar/fdsc3/p01Byfmf3rk9/6NbsupoljsIpDD.jpg', 'シ华灯初上ミ旧人可安°', '2019-06-21', 65, '画质太清晰了，玩和平精英下面的书一目了然', 'https://i1.mifile.cn/a2/1561084401_2972019_s750_1000wh!240x241.jpg', '[\r\n                {\r\n                    \"name\":\"官方回复\",\r\n                    \"src\":\"http://www.zlpones.com/imgs/mi/icon/小米.png\",\r\n                    \"val\":\"越过山林，穿过薄雾，我愿意陪你等在湖海之畔，看月亮升起~感谢您对小米的支持 *★,°*:.☆(￣▽￣)/$:*.°★* \"\r\n                }\r\n            ]'),
(2, '小米9', 'https://cdn.cnbj0.fds.api.mi-img.com/b2c-data-mishop/52cc4721e1eaed5af47af693906205c8.jpg', '22*63', '2019-08-01', 21, '买米9就是为了吃鸡，今天第一天上手，哇塞，很流畅，第一把就吃到鸡了，有了米9，原来吃鸡这么简单，之前的米6可以下岗了', 'https://i1.mifile.cn/a2/1564642694_6919954_s1080_2340wh!240x241.jpg~~~https://i1.mifile.cn/a2/1564642693_6538720_s1080_2340wh!240x241.jpg', '[\r\n                {\r\n                    \"name\":\"官方回复\",\r\n                    \"src\":\"http://www.zlpones.com/imgs/mi/icon/小米.png\",\r\n                    \"val\":\"以前喜欢一个女生她对我说，她喜欢会打游戏的男生，于是我发愤图强苦练游戏，过了两个月，我把那女孩忘得一-干二净了~感谢您对小米的支持。\"\r\n                }\r\n            ]'),
(3, '小米9', 'https://cdn.cnbj0.fds.api.mi-img.com/b2c-data-mishop/c2967dfef7e98df036c463d50041edf7.png', '848****38', '2019-07-31', 11, '应该是第八个米了，从1开始用没用过其他品牌。越来越好！坚挺！', 'https://i1.mifile.cn/a2/1564531709_4675198_s2305_2305wh!240x241.jpg~~~https://i1.mifile.cn/a2/1564531708_6030652_s2160_2160wh!240x241.jpg~~~https://i1.mifile.cn/a2/1564531708_3992931_s1440_2160wh!240x241.jpg~~~https://i1.mifile.cn/a2/1564531707_3344352_s1279_1950wh!240x241.jpg', '[\r\n                {\r\n                    \"name\":\"官方回复\",\r\n                    \"src\":\"http://www.zlpones.com/imgs/mi/icon/小米.png\",\r\n                    \"val\":\"啊啊啊啊，好可爱啊，这是要骗大汉去你家看猫猫吗？好的，你成功了~感谢您对小米的支持。 \"\r\n                }\r\n            ]'),
...
(9, '小米9', 'https://s1.mi-img.com/mfsv2/avatar/s010/p01kASeBJLh3/hqPh4XDYM0cWem.jpg', '邢嘉嘉', '2019-07-29', 31, '从小米4 换小米note2又换到小米6现在又到米9', 'https://i1.mifile.cn/a2/1564348765_7409990_s1125_2000wh!540x5400.jpg?w=540&h=960', '[\r\n                {\r\n                    \"name\":\"官方回复\",\r\n                    \"src\":\"http://www.zlpones.com/imgs/mi/icon/小米.png\",\r\n                    \"val\":\"从小米4 换小米note2又换到小米6现在又到米9，你没发现你的收集还差了最重要的一个吗？那就是—小米客服。抠脚蜀黍客服愿意做你的优乐美，你愿意吗？感谢您对小米的支持。\"\r\n                },\r\n            ]');
...
CREATE TABLE `mimi_details_style` (
  ...
  `d_style_iconList` varchar(3096) CHARACTER SET utf8 NOT NULL,
  `d_style_installment` varchar(2048) CHARACTER SET utf8 NOT NULL,
  `d_style_promise` varchar(1024) CHARACTER SET utf8 NOT NULL,
  `d_style_price` int(11) NOT NULL,
  `d_style_original_price` int(11) NOT NULL,
  `d_style_MaxCount` int(11) NOT NULL,
  `d_style_model` varchar(64) CHARACTER SET utf8 NOT NULL,
  `d_style_version` varchar(64) CHARACTER SET utf8 NOT NULL,
  `p_set_meal` varchar(64) CHARACTER SET utf8 NOT NULL,
  `d_style_disk` varchar(64) CHARACTER SET utf8 NOT NULL,
  `d_style_color` varchar(64) CHARACTER SET utf8 NOT NULL,
  `d_style_size` varchar(64) CHARACTER SET utf8 NOT NULL,
...
INSERT INTO `mimi_details_style` (`d_style_id`, `p_name`, `d_style_src`, `d_style_imgs`, `d_style_iconList`, `d_style_installment`, `d_style_promise`, `d_style_price`, `d_style_original_price`, `d_style_MaxCount`, `d_style_model`, `d_style_version`, `p_set_meal`, `d_style_disk`, `d_style_color`, `d_style_size`, `d_style_seckill`, `d_seckill_price`, `d_seckill_time`, `d_style_status`, `d_style_high_title`, `d_style_sub_title`, `p_info`) VALUES
(1, '小米9', 'https://i8.mifile.cn/a1/pms_1550642167.03594225.jpg', '[\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/66d9e4941faefdd393be723d5c342e46.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/9191ffd44030e7d0bf8c5a91ffdbb2f5.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/b72810544b8b8f4150d2b88a667d06bc.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/3fa0db6388e2150f6f128958641e456d.jpg\"\r\n        ]', '[\r\n                {\r\n                    src:\'https://cdn.cnbj0.fds.api.mi-img.com/b2c-mimall-media/f0c04e138bfed2b1ebb589de615236d1.png\',\r\n                    name:\'CPU\',\r\n                    val:\'骁龙855八核\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/7692726e7a1dd34a3b1b4ede8aca020d.png\',\r\n                    name:\'三摄像头\',\r\n                    val:\'4800万+1200万+1600万像素\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/86a3bd46cf4f7f19daa2c3250cf30604.png\',\r\n                    name:\'超大屏\',\r\n                    val:\'6.39英寸\'\r\n                },      \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/a5ab24dcb527e49f970f13b11e000ab1.png\',\r\n                    name:\'屏幕分辨率\',\r\n                    val:\'2340×1080\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/c8ec0829241324e401744da627482560.png\',\r\n                    name:\'极速畅玩\',\r\n                    val:\'6GB\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/8941adac25333e785b9cc78ca11f4f27.png\',\r\n                    name:\'存储容量\',\r\n                    val:\'128GB\'\r\n                },   \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/52ad10a73685342e437e44ea3d29cbff.png\',\r\n                    name:\'普通厚度\',\r\n                    val:\'7.61mm\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/0b4ea0fb21dde2f29df3c20de73539b9.png\',\r\n                    name:\'持久待机\',\r\n                    val:\'3300mAh\'\r\n                },    \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/d1b67a407fb2a1ed42c2c0ce15af3318.png\',\r\n                    name:\'运营商网络\',\r\n                    val:\'4G全网通\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/bfd5ba9ae72c365dee42db14dfae4b0f.png\',\r\n                    name:\'网络模式\',\r\n                    val:\'双卡双待\'\r\n                },                                                                       \r\n            ]', '[                 {                     name:\'小米分期\',                     checked:true,                     values:[                         {                             name:3,                             rate:0.0222,                             checked:true,                             val:true                         },                         {                             name:6,                             rate:0.039,                             checked:false,                             val:true                         },                         {                             name:12,                             rate:0.072,                             checked:false,                             val:true                         },                                                                             ]                 },                 {                     name:\'花呗分期\',                     checked:false,                     values:[                         {                             name:3,                             rate:0.023,                             checked:true,                             val:true                         },                         {                             name:6,                             rate:0.045,                             checked:false,                             val:true                         },                         {                             name:12,                             rate:0.075,                             checked:false,                             val:true                         },                                                                             ]                 }                                ]', '[\r\n                {\r\n                    name:\"小米自营\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"小米发货\",\r\n                    val:\"由小米发货\"\r\n                },\r\n                {\r\n                    name:\"7天无理由退货\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"\",\r\n                    val:\"由小米发货的商品，单笔满150元免运费;由第三方商家发货的商品，免运费;特殊商品需要单独收取运费，具体以实际结算金额为准；优惠券等不能抵扣运费金额;\"\r\n                }                                                \r\n            ]', 2599, 2999, 4, '全网通版', '6GB+128GB', '标配', '128GB', '深空灰', '', '无秒杀', 0, 10000000, '有现货', '「6GB+128GB版本直降200元，仅需2799元」', '全曲面轻薄设计，全息幻彩玻璃机身 / 骁龙855旗舰处理器 / 20W无线闪充，标配27W有线快充 / 索尼4800万超广角微距三摄 / 极速屏下指纹解锁 / 多功能NFC', '小米9 全网通版 6GB+128GB 深空灰'),
(2, '小米9', 'https://i8.mifile.cn/a1/pms_1550642185.33171962.jpg', '[\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/448120635699d43273ea74437548b6eb.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/55ea24d46d1f3d15dfd4a18cef40c816.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/7a41c671f0a6c3faa5d982b61031e17f.jpg\"\r\n        ]', '[\r\n                {\r\n                    src:\'https://cdn.cnbj0.fds.api.mi-img.com/b2c-mimall-media/f0c04e138bfed2b1ebb589de615236d1.png\',\r\n                    name:\'CPU\',\r\n                    val:\'骁龙855八核\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/7692726e7a1dd34a3b1b4ede8aca020d.png\',\r\n                    name:\'三摄像头\',\r\n                    val:\'4800万+1200万+1600万像素\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/86a3bd46cf4f7f19daa2c3250cf30604.png\',\r\n                    name:\'超大屏\',\r\n                    val:\'6.39英寸\'\r\n                },      \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/a5ab24dcb527e49f970f13b11e000ab1.png\',\r\n                    name:\'屏幕分辨率\',\r\n                    val:\'2340×1080\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/c8ec0829241324e401744da627482560.png\',\r\n                    name:\'极速畅玩\',\r\n                    val:\'6GB\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/8941adac25333e785b9cc78ca11f4f27.png\',\r\n                    name:\'存储容量\',\r\n                    val:\'128GB\'\r\n                },   \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/52ad10a73685342e437e44ea3d29cbff.png\',\r\n                    name:\'普通厚度\',\r\n                    val:\'7.61mm\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/0b4ea0fb21dde2f29df3c20de73539b9.png\',\r\n                    name:\'持久待机\',\r\n                    val:\'3300mAh\'\r\n                },    \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/d1b67a407fb2a1ed42c2c0ce15af3318.png\',\r\n                    name:\'运营商网络\',\r\n                    val:\'4G全网通\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/bfd5ba9ae72c365dee42db14dfae4b0f.png\',\r\n                    name:\'网络模式\',\r\n                    val:\'双卡双待\'\r\n                },                                                                       \r\n            ]', '[                 {                     name:\'小米分期\',                     checked:true,                     values:[                         {                             name:3,                             rate:0.0222,                             checked:true,                             val:true                         },                         {                             name:6,                             rate:0.039,                             checked:false,                             val:true                         },                         {                             name:12,                             rate:0.072,                             checked:false,                             val:true                         },                                                                             ]                 },                 {                     name:\'花呗分期\',                     checked:false,                     values:[                         {                             name:3,                             rate:0.023,                             checked:true,                             val:true                         },                         {                             name:6,                             rate:0.045,                             checked:false,                             val:true                         },                         {                             name:12,                             rate:0.075,                             checked:false,                             val:true                         },                                                                             ]                 }                                ]', '[\r\n                {\r\n                    name:\"小米自营\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"小米发货\",\r\n                    val:\"由小米发货\"\r\n                },\r\n                {\r\n                    name:\"7天无理由退货\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"\",\r\n                    val:\"由小米发货的商品，单笔满150元免运费;由第三方商家发货的商品，免运费;特殊商品需要单独收取运费，具体以实际结算金额为准；优惠券等不能抵扣运费金额;\"\r\n                }                                                \r\n            ]', 2599, 2999, 4, '全网通版', '6GB+128GB', '标配', '128GB', '全息幻彩紫', '', '无秒杀', 0, 10000000, '有现货', '「6GB+128GB版本直降200元，仅需2799元」', '全曲面轻薄设计，全息幻彩玻璃机身 / 骁龙855旗舰处理器 / 20W无线闪充，标配27W有线快充 / 索尼4800万超广角微距三摄 / 极速屏下指纹解锁 / 多功能NFC', '小米9 全网通版 6GB+128GB 全息幻彩紫'),
(3, '小米9', 'https://i8.mifile.cn/a1/pms_1550642182.7527088.jpg', '[\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/6bfc7f28953b13ca6130a93500d05ef3.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/b71db4e1e0718740490bf491c8809e78.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/850678f51692e6c55a0b610333383a1e.jpg\"\r\n        ]', '[\r\n                {\r\n                    src:\'https://cdn.cnbj0.fds.api.mi-img.com/b2c-mimall-media/f0c04e138bfed2b1ebb589de615236d1.png\',\r\n                    name:\'CPU\',\r\n                    val:\'骁龙855八核\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/7692726e7a1dd34a3b1b4ede8aca020d.png\',\r\n                    name:\'三摄像头\',\r\n                    val:\'4800万+1200万+1600万像素\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/86a3bd46cf4f7f19daa2c3250cf30604.png\',\r\n                    name:\'超大屏\',\r\n                    val:\'6.39英寸\'\r\n                },      \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/a5ab24dcb527e49f970f13b11e000ab1.png\',\r\n                    name:\'屏幕分辨率\',\r\n                    val:\'2340×1080\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/c8ec0829241324e401744da627482560.png\',\r\n                    name:\'极速畅玩\',\r\n                    val:\'6GB\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/8941adac25333e785b9cc78ca11f4f27.png\',\r\n                    name:\'存储容量\',\r\n                    val:\'128GB\'\r\n                },   \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/52ad10a73685342e437e44ea3d29cbff.png\',\r\n                    name:\'普通厚度\',\r\n                    val:\'7.61mm\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/0b4ea0fb21dde2f29df3c20de73539b9.png\',\r\n                    name:\'持久待机\',\r\n                    val:\'3300mAh\'\r\n                },    \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/d1b67a407fb2a1ed42c2c0ce15af3318.png\',\r\n                    name:\'运营商网络\',\r\n                    val:\'4G全网通\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/bfd5ba9ae72c365dee42db14dfae4b0f.png\',\r\n                    name:\'网络模式\',\r\n                    val:\'双卡双待\'\r\n                },                                                                       \r\n            ]', '[                 {                     name:\'小米分期\',                     checked:true,                     values:[                         {                             name:3,                             rate:0.0222,                             checked:true,                             val:true                         },                         {                             name:6,                             rate:0.039,                             checked:false,                             val:true                         },                         {                             name:12,                             rate:0.072,                             checked:false,                             val:true                         },                                                                             ]                 },                 {                     name:\'花呗分期\',                     checked:false,                     values:[                         {                             name:3,                             rate:0.023,                             checked:true,                             val:true                         },                         {                             name:6,                             rate:0.045,                             checked:false,                             val:true                         },                         {                             name:12,                             rate:0.075,                             checked:false,                             val:true                         },                                                                             ]                 }                                ]', '[\r\n                {\r\n                    name:\"小米自营\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"小米发货\",\r\n                    val:\"由小米发货\"\r\n                },\r\n                {\r\n                    name:\"7天无理由退货\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"\",\r\n                    val:\"由小米发货的商品，单笔满150元免运费;由第三方商家发货的商品，免运费;特殊商品需要单独收取运费，具体以实际结算金额为准；优惠券等不能抵扣运费金额;\"\r\n                }                                                \r\n            ]', 2599, 2999, 4, '全网通版', '6GB+128GB', '标配', '128GB', '全息幻彩蓝', '', '无秒杀', 0, 10000000, '有现货', '「6GB+128GB版本直降200元，仅需2799元」', '全曲面轻薄设计，全息幻彩玻璃机身 / 骁龙855旗舰处理器 / 20W无线闪充，标配27W有线快充 / 索尼4800万超广角微距三摄 / 极速屏下指纹解锁 / 多功能NFC', '小米9 全网通版 6GB+128GB 全息幻彩蓝'),
(4, '小米9', 'https://i8.mifile.cn/a1/pms_1550642167.03594225.jpg', '[\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/66d9e4941faefdd393be723d5c342e46.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/9191ffd44030e7d0bf8c5a91ffdbb2f5.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/b72810544b8b8f4150d2b88a667d06bc.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/3fa0db6388e2150f6f128958641e456d.jpg\"\r\n        ]', '[\r\n                {\r\n                    src:\'https://cdn.cnbj0.fds.api.mi-img.com/b2c-mimall-media/f0c04e138bfed2b1ebb589de615236d1.png\',\r\n                    name:\'CPU\',\r\n                    val:\'骁龙855八核\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/7692726e7a1dd34a3b1b4ede8aca020d.png\',\r\n                    name:\'三摄像头\',\r\n                    val:\'4800万+1200万+1600万像素\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/86a3bd46cf4f7f19daa2c3250cf30604.png\',\r\n                    name:\'超大屏\',\r\n                    val:\'6.39英寸\'\r\n                },      \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/a5ab24dcb527e49f970f13b11e000ab1.png\',\r\n                    name:\'屏幕分辨率\',\r\n                    val:\'2340×1080\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/c8ec0829241324e401744da627482560.png\',\r\n                    name:\'极速畅玩\',\r\n                    val:\'8GB\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/8941adac25333e785b9cc78ca11f4f27.png\',\r\n                    name:\'存储容量\',\r\n                    val:\'128GB\'\r\n                },   \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/52ad10a73685342e437e44ea3d29cbff.png\',\r\n                    name:\'普通厚度\',\r\n                    val:\'7.61mm\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/0b4ea0fb21dde2f29df3c20de73539b9.png\',\r\n                    name:\'持久待机\',\r\n                    val:\'3300mAh\'\r\n                },    \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/d1b67a407fb2a1ed42c2c0ce15af3318.png\',\r\n                    name:\'运营商网络\',\r\n                    val:\'4G全网通\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/bfd5ba9ae72c365dee42db14dfae4b0f.png\',\r\n                    name:\'网络模式\',\r\n                    val:\'双卡双待\'\r\n                },                                                                       \r\n            ]', '[                 {                     name:\'小米分期\',                     checked:true,                     values:[                         {                             name:3,                             rate:0.0222,                             checked:true,                             val:true                         },                         {                             name:6,                             rate:0.039,                             checked:false,                             val:true                         },                         {                             name:12,                             rate:0.072,                             checked:false,                             val:true                         },                                                                             ]                 },                 {                     name:\'花呗分期\',                     checked:false,                     values:[                         {                             name:3,                             rate:0.023,                             checked:true,                             val:true                         },                         {                             name:6,                             rate:0.045,                             checked:false,                             val:true                         },                         {                             name:12,                             rate:0.075,                             checked:false,                             val:true                         },                                                                             ]                 }                                ]', '[\r\n                {\r\n                    name:\"小米自营\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"小米发货\",\r\n                    val:\"由小米发货\"\r\n                },\r\n                {\r\n                    name:\"7天无理由退货\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"\",\r\n                    val:\"由小米发货的商品，单笔满150元免运费;由第三方商家发货的商品，免运费;特殊商品需要单独收取运费，具体以实际结算金额为准；优惠券等不能抵扣运费金额;\"\r\n                }                                                \r\n            ]', 2999, 3299, 3, '全网通版', '8GB+128GB', '标配', '128GB', '深空灰', '', '无秒杀', 0, 10000000, '有现货', '「8GB+128GB版赠价值149元无线充电宝或价值169元无线车充（二选一）」', '全曲面轻薄设计，全息幻彩玻璃机身 / 骁龙855旗舰处理器 / 20W无线闪充，标配27W有线快充 / 索尼4800万超广角微距三摄 / 极速屏下指纹解锁 / 多功能NFC', '小米9 全网通版 8GB+128GB 深空灰'),
(6, '小米9', 'https://i8.mifile.cn/a1/pms_1550642185.33171962.jpg', '[\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/448120635699d43273ea74437548b6eb.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/55ea24d46d1f3d15dfd4a18cef40c816.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/7a41c671f0a6c3faa5d982b61031e17f.jpg\"\r\n        ]', '[\r\n                {\r\n                    src:\'https://cdn.cnbj0.fds.api.mi-img.com/b2c-mimall-media/f0c04e138bfed2b1ebb589de615236d1.png\',\r\n                    name:\'CPU\',\r\n                    val:\'骁龙855八核\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/7692726e7a1dd34a3b1b4ede8aca020d.png\',\r\n                    name:\'三摄像头\',\r\n                    val:\'4800万+1200万+1600万像素\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/86a3bd46cf4f7f19daa2c3250cf30604.png\',\r\n                    name:\'超大屏\',\r\n                    val:\'6.39英寸\'\r\n                },      \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/a5ab24dcb527e49f970f13b11e000ab1.png\',\r\n                    name:\'屏幕分辨率\',\r\n                    val:\'2340×1080\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/c8ec0829241324e401744da627482560.png\',\r\n                    name:\'极速畅玩\',\r\n                    val:\'8GB\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/8941adac25333e785b9cc78ca11f4f27.png\',\r\n                    name:\'存储容量\',\r\n                    val:\'128GB\'\r\n                },   \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/52ad10a73685342e437e44ea3d29cbff.png\',\r\n                    name:\'普通厚度\',\r\n                    val:\'7.61mm\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/0b4ea0fb21dde2f29df3c20de73539b9.png\',\r\n                    name:\'持久待机\',\r\n                    val:\'3300mAh\'\r\n                },    \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/d1b67a407fb2a1ed42c2c0ce15af3318.png\',\r\n                    name:\'运营商网络\',\r\n                    val:\'4G全网通\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/bfd5ba9ae72c365dee42db14dfae4b0f.png\',\r\n                    name:\'网络模式\',\r\n                    val:\'双卡双待\'\r\n                },                                                                       \r\n            ]', '[                 {                     name:\'小米分期\',                     checked:true,                     values:[                         {                             name:3,                             rate:0.0222,                             checked:true,                             val:true                         },                         {                             name:6,                             rate:0.039,                             checked:false,                             val:true                         },                         {                             name:12,                             rate:0.072,                             checked:false,                             val:true                         },                                                                             ]                 },                 {                     name:\'花呗分期\',                     checked:false,                     values:[                         {                             name:3,                             rate:0.023,                             checked:true,                             val:true                         },                         {                             name:6,                             rate:0.045,                             checked:false,                             val:true                         },                         {                             name:12,                             rate:0.075,                             checked:false,                             val:true                         },                                                                             ]                 }                                ]', '[\r\n                {\r\n                    name:\"小米自营\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"小米发货\",\r\n                    val:\"由小米发货\"\r\n                },\r\n                {\r\n                    name:\"7天无理由退货\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"\",\r\n                    val:\"由小米发货的商品，单笔满150元免运费;由第三方商家发货的商品，免运费;特殊商品需要单独收取运费，具体以实际结算金额为准；优惠券等不能抵扣运费金额;\"\r\n                }                                                \r\n            ]', 2999, 3299, 3, '全网通版', '8GB+128GB', '标配', '128GB', '全息幻彩紫', '', '无秒杀', 0, 10000000, '有现货', '「8GB+128GB版赠价值149元无线充电宝或价值169元无线车充（二选一）」', '全曲面轻薄设计，全息幻彩玻璃机身 / 骁龙855旗舰处理器 / 20W无线闪充，标配27W有线快充 / 索尼4800万超广角微距三摄 / 极速屏下指纹解锁 / 多功能NFC', '小米9 全网通版 8GB+128GB 全息幻彩紫'),
(7, '小米9', 'https://i8.mifile.cn/a1/pms_1550642182.7527088.jpg', '[\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/6bfc7f28953b13ca6130a93500d05ef3.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/b71db4e1e0718740490bf491c8809e78.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/850678f51692e6c55a0b610333383a1e.jpg\"\r\n        ]', '[\r\n                {\r\n                    src:\'https://cdn.cnbj0.fds.api.mi-img.com/b2c-mimall-media/f0c04e138bfed2b1ebb589de615236d1.png\',\r\n                    name:\'CPU\',\r\n                    val:\'骁龙855八核\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/7692726e7a1dd34a3b1b4ede8aca020d.png\',\r\n                    name:\'三摄像头\',\r\n                    val:\'4800万+1200万+1600万像素\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/86a3bd46cf4f7f19daa2c3250cf30604.png\',\r\n                    name:\'超大屏\',\r\n                    val:\'6.39英寸\'\r\n                },      \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/a5ab24dcb527e49f970f13b11e000ab1.png\',\r\n                    name:\'屏幕分辨率\',\r\n                    val:\'2340×1080\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/c8ec0829241324e401744da627482560.png\',\r\n                    name:\'极速畅玩\',\r\n                    val:\'8GB\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/8941adac25333e785b9cc78ca11f4f27.png\',\r\n                    name:\'存储容量\',\r\n                    val:\'128GB\'\r\n                },   \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/52ad10a73685342e437e44ea3d29cbff.png\',\r\n                    name:\'普通厚度\',\r\n                    val:\'7.61mm\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/0b4ea0fb21dde2f29df3c20de73539b9.png\',\r\n                    name:\'持久待机\',\r\n                    val:\'3300mAh\'\r\n                },    \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/d1b67a407fb2a1ed42c2c0ce15af3318.png\',\r\n                    name:\'运营商网络\',\r\n                    val:\'4G全网通\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/bfd5ba9ae72c365dee42db14dfae4b0f.png\',\r\n                    name:\'网络模式\',\r\n                    val:\'双卡双待\'\r\n                },                                                                       \r\n            ]', '[                 {                     name:\'小米分期\',                     checked:true,                     values:[                         {                             name:3,                             rate:0.0222,                             checked:true,                             val:true                         },                         {                             name:6,                             rate:0.039,                             checked:false,                             val:true                         },                         {                             name:12,                             rate:0.072,                             checked:false,                             val:true                         },                                                                             ]                 },                 {                     name:\'花呗分期\',                     checked:false,                     values:[                         {                             name:3,                             rate:0.023,                             checked:true,                             val:true                         },                         {                             name:6,                             rate:0.045,                             checked:false,                             val:true                         },                         {                             name:12,                             rate:0.075,                             checked:false,                             val:true                         },                                                                             ]                 }                                ]', '[\r\n                {\r\n                    name:\"小米自营\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"小米发货\",\r\n                    val:\"由小米发货\"\r\n                },\r\n                {\r\n                    name:\"7天无理由退货\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"\",\r\n                    val:\"由小米发货的商品，单笔满150元免运费;由第三方商家发货的商品，免运费;特殊商品需要单独收取运费，具体以实际结算金额为准；优惠券等不能抵扣运费金额;\"\r\n                }                                                \r\n            ]', 2999, 3299, 3, '全网通版', '8GB+128GB', '标配', '128GB', '全息幻彩蓝', '', '无秒杀', 0, 10000000, '有现货', '「8GB+128GB版赠价值149元无线充电宝或价值169元无线车充（二选一）」', '全曲面轻薄设计，全息幻彩玻璃机身 / 骁龙855旗舰处理器 / 20W无线闪充，标配27W有线快充 / 索尼4800万超广角微距三摄 / 极速屏下指纹解锁 / 多功能NFC', '小米9 全网通版 8GB+128GB 全息幻彩蓝'),
(8, '小米9', 'https://i8.mifile.cn/a1/pms_1553001921.97126644.jpg', '[\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/7d1ddda193d48d059ddab965138b31e9.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/ad87ad1c451431eeab5fab19f8a9bdb0.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/c7695c104627574197faa2eba3827b85.jpg\"\r\n        ]', '[\r\n                {\r\n                    src:\'https://cdn.cnbj0.fds.api.mi-img.com/b2c-mimall-media/f0c04e138bfed2b1ebb589de615236d1.png\',\r\n                    name:\'CPU\',\r\n                    val:\'骁龙855八核\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/7692726e7a1dd34a3b1b4ede8aca020d.png\',\r\n                    name:\'三摄像头\',\r\n                    val:\'4800万+1200万+1600万像素\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/86a3bd46cf4f7f19daa2c3250cf30604.png\',\r\n                    name:\'超大屏\',\r\n                    val:\'6.39英寸\'\r\n                },      \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/a5ab24dcb527e49f970f13b11e000ab1.png\',\r\n                    name:\'屏幕分辨率\',\r\n                    val:\'2340×1080\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/c8ec0829241324e401744da627482560.png\',\r\n                    name:\'极速畅玩\',\r\n                    val:\'8GB\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/8941adac25333e785b9cc78ca11f4f27.png\',\r\n                    name:\'存储容量\',\r\n                    val:\'256GB\'\r\n                },   \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/52ad10a73685342e437e44ea3d29cbff.png\',\r\n                    name:\'普通厚度\',\r\n                    val:\'7.61mm\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/0b4ea0fb21dde2f29df3c20de73539b9.png\',\r\n                    name:\'持久待机\',\r\n                    val:\'3300mAh\'\r\n                },    \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/d1b67a407fb2a1ed42c2c0ce15af3318.png\',\r\n                    name:\'运营商网络\',\r\n                    val:\'4G全网通\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/bfd5ba9ae72c365dee42db14dfae4b0f.png\',\r\n                    name:\'网络模式\',\r\n                    val:\'双卡双待\'\r\n                },                                                                       \r\n            ]', '[                 {                     name:\'小米分期\',                     checked:true,                     values:[                         {                             name:3,                             rate:0.0222,                             checked:true,                             val:true                         },                         {                             name:6,                             rate:0.039,                             checked:false,                             val:true                         },                         {                             name:12,                             rate:0.072,                             checked:false,                             val:true                         },                                                                             ]                 },                 {                     name:\'花呗分期\',                     checked:false,                     values:[                         {                             name:3,                             rate:0.023,                             checked:true,                             val:true                         },                         {                             name:6,                             rate:0.045,                             checked:false,                             val:true                         },                         {                             name:12,                             rate:0.075,                             checked:false,                             val:true                         },                                                                             ]                 }                                ]', '[\r\n                {\r\n                    name:\"小米自营\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"小米发货\",\r\n                    val:\"由小米发货\"\r\n                },\r\n                {\r\n                    name:\"7天无理由退货\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"\",\r\n                    val:\"由小米发货的商品，单笔满150元免运费;由第三方商家发货的商品，免运费;特殊商品需要单独收取运费，具体以实际结算金额为准；优惠券等不能抵扣运费金额;\"\r\n                }                                                \r\n            ]', 3699, 0, 2, '全网通版', '8GB+256GB', '标配', '256GB', '透明版', '', '无秒杀', 0, 10000000, '有现货', '「8GB+256GB版赠价值149元无线充电宝或价值169元无线车充（二选一）」', '全曲面轻薄设计，全息幻彩玻璃机身 / 骁龙855旗舰处理器 / 20W无线闪充，标配27W有线快充 / 索尼4800万超广角微距三摄 / 极速屏下指纹解锁 / 多功能NFC', '小米9 全网通版 8GB+256GB 透明版'),
(9, '黑鲨手机2 Pro', 'https://i8.mifile.cn/a1/pms_1564309745.17776332.jpg', '[\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/1e4b88dc3086075195d83eb51e48f515.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/a889720320243aa07ae63963a02ea66e.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/4b1c2f1c0c858d343f3c4bdb96acff43.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/c578bedeedf28b89eaadd19e5eeba969.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/9f622f12af9172bc48c73c599d02bc45.jpg\"\r\n        ]', '[\r\n                {\r\n                    src:\'https://cdn.cnbj0.fds.api.mi-img.com/b2c-mimall-media/f0c04e138bfed2b1ebb589de615236d1.png\',\r\n                    name:\'CPU\',\r\n                    val:\'骁龙855+\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/7692726e7a1dd34a3b1b4ede8aca020d.png\',\r\n                    name:\'双摄像头\',\r\n                    val:\'4800万+1200万像素\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/86a3bd46cf4f7f19daa2c3250cf30604.png\',\r\n                    name:\'超大屏\',\r\n                    val:\'6.39英寸\'\r\n                },      \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/a5ab24dcb527e49f970f13b11e000ab1.png\',\r\n                    name:\'屏幕分辨率\',\r\n                    val:\'2340×1080\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/c8ec0829241324e401744da627482560.png\',\r\n                    name:\'极速畅玩\',\r\n                    val:\'12GB\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/8941adac25333e785b9cc78ca11f4f27.png\',\r\n                    name:\'存储容量\',\r\n                    val:\'128GB\'\r\n                },   \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/0b4ea0fb21dde2f29df3c20de73539b9.png\',\r\n                    name:\'超长待机\',\r\n                    val:\'4000mAh\'\r\n                },    \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/d1b67a407fb2a1ed42c2c0ce15af3318.png\',\r\n                    name:\'运营商网络\',\r\n                    val:\'4G全网通\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/bfd5ba9ae72c365dee42db14dfae4b0f.png\',\r\n                    name:\'网络模式\',\r\n                    val:\'双卡双待\'\r\n                },                                                                       \r\n            ]', '[]', '[\r\n                {\r\n                    name:\"小米自营\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"小米发货\",\r\n                    val:\"由小米发货\"\r\n                },\r\n                {\r\n                    name:\"7天无理由退货\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"\",\r\n                    val:\"由小米发货的商品，单笔满150元免运费;由第三方商家发货的商品，免运费;特殊商品需要单独收取运费，具体以实际结算金额为准；优惠券等不能抵扣运费金额;\"\r\n                }                                                \r\n            ]', 2999, 2999, 5, '全网通版', '12GB+128GB', '标配', '128GB', '冰魄灰', '', '无秒杀', 0, 10000000, '有现货', '「新品热卖，可选+100元得游戏手柄」', '骁龙855 Plus旗舰处理器 / UFS 3.0 高速闪存 / 全系标配12GB大运存 / 液冷3.0+，全域液冷升级 / 电竞级屏幕压感，操作快人一步 / 独显DC调光2.0 护眼全新升级', '黑鲨游戏手机2 Pro 12GB+128GB 冰魄灰'),
(10, '黑鲨手机2 Pro', 'https://i8.mifile.cn/a1/pms_1567007329.86589323.jpg', '[\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/1e4b88dc3086075195d83eb51e48f515.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/a889720320243aa07ae63963a02ea66e.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/4b1c2f1c0c858d343f3c4bdb96acff43.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/c578bedeedf28b89eaadd19e5eeba969.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/9f622f12af9172bc48c73c599d02bc45.jpg\"\r\n        ]', '[\r\n                {\r\n                    src:\'https://cdn.cnbj0.fds.api.mi-img.com/b2c-mimall-media/f0c04e138bfed2b1ebb589de615236d1.png\',\r\n                    name:\'CPU\',\r\n                    val:\'骁龙855+\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/7692726e7a1dd34a3b1b4ede8aca020d.png\',\r\n                    name:\'双摄像头\',\r\n                    val:\'4800万+1200万像素\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/86a3bd46cf4f7f19daa2c3250cf30604.png\',\r\n                    name:\'超大屏\',\r\n                    val:\'6.39英寸\'\r\n                },      \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/a5ab24dcb527e49f970f13b11e000ab1.png\',\r\n                    name:\'屏幕分辨率\',\r\n                    val:\'2340×1080\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/c8ec0829241324e401744da627482560.png\',\r\n                    name:\'极速畅玩\',\r\n                    val:\'12GB\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/8941adac25333e785b9cc78ca11f4f27.png\',\r\n                    name:\'存储容量\',\r\n                    val:\'128GB\'\r\n                },   \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/0b4ea0fb21dde2f29df3c20de73539b9.png\',\r\n                    name:\'超长待机\',\r\n                    val:\'4000mAh\'\r\n                },    \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/d1b67a407fb2a1ed42c2c0ce15af3318.png\',\r\n                    name:\'运营商网络\',\r\n                    val:\'4G全网通\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/bfd5ba9ae72c365dee42db14dfae4b0f.png\',\r\n                    name:\'网络模式\',\r\n                    val:\'双卡双待\'\r\n                },                                                                       \r\n            ]', '[]', '[\r\n                {\r\n                    name:\"小米自营\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"小米发货\",\r\n                    val:\"由小米发货\"\r\n                },\r\n                {\r\n                    name:\"7天无理由退货\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"\",\r\n                    val:\"由小米发货的商品，单笔满150元免运费;由第三方商家发货的商品，免运费;特殊商品需要单独收取运费，具体以实际结算金额为准；优惠券等不能抵扣运费金额;\"\r\n                }                                                \r\n            ]', 3118, 3118, 5, '全网通版', '12GB+128GB', '+119元得黑鲨双向快充移动电源', '128GB', '冰魄灰', '', '无秒杀', 0, 10000000, '有现货', '「新品热卖，可选+100元得游戏手柄」', '骁龙855 Plus旗舰处理器 / UFS 3.0 高速闪存 / 全系标配12GB大运存 / 液冷3.0+，全域液冷升级 / 电竞级屏幕压感，操作快人一步 / 独显DC调光2.0 护眼全新升级', '黑鲨游戏手机2 Pro 12GB/128GB+黑鲨移动电源套装'),
(11, '黑鲨手机2 Pro', 'https://i8.mifile.cn/a1/pms_1567315640.31439124.jpg', '[\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/1e4b88dc3086075195d83eb51e48f515.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/a889720320243aa07ae63963a02ea66e.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/4b1c2f1c0c858d343f3c4bdb96acff43.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/c578bedeedf28b89eaadd19e5eeba969.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/9f622f12af9172bc48c73c599d02bc45.jpg\"\r\n        ]', '[\r\n                {\r\n                    src:\'https://cdn.cnbj0.fds.api.mi-img.com/b2c-mimall-media/f0c04e138bfed2b1ebb589de615236d1.png\',\r\n                    name:\'CPU\',\r\n                    val:\'骁龙855+\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/7692726e7a1dd34a3b1b4ede8aca020d.png\',\r\n                    name:\'双摄像头\',\r\n                    val:\'4800万+1200万像素\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/86a3bd46cf4f7f19daa2c3250cf30604.png\',\r\n                    name:\'超大屏\',\r\n                    val:\'6.39英寸\'\r\n                },      \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/a5ab24dcb527e49f970f13b11e000ab1.png\',\r\n                    name:\'屏幕分辨率\',\r\n                    val:\'2340×1080\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/c8ec0829241324e401744da627482560.png\',\r\n                    name:\'极速畅玩\',\r\n                    val:\'12GB\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/8941adac25333e785b9cc78ca11f4f27.png\',\r\n                    name:\'存储容量\',\r\n                    val:\'128GB\'\r\n                },   \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/0b4ea0fb21dde2f29df3c20de73539b9.png\',\r\n                    name:\'超长待机\',\r\n                    val:\'4000mAh\'\r\n                },    \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/d1b67a407fb2a1ed42c2c0ce15af3318.png\',\r\n                    name:\'运营商网络\',\r\n                    val:\'4G全网通\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/bfd5ba9ae72c365dee42db14dfae4b0f.png\',\r\n                    name:\'网络模式\',\r\n                    val:\'双卡双待\'\r\n                },                                                                       \r\n            ]', '[]', '[\r\n                {\r\n                    name:\"小米自营\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"小米发货\",\r\n                    val:\"由小米发货\"\r\n                },\r\n                {\r\n                    name:\"7天无理由退货\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"\",\r\n                    val:\"由小米发货的商品，单笔满150元免运费;由第三方商家发货的商品，免运费;特殊商品需要单独收取运费，具体以实际结算金额为准；优惠券等不能抵扣运费金额;\"\r\n                }                                                \r\n            ]', 3099, 0, 5, '全网通版', '12GB+128GB', '+100元得黑鲨左手柄游戏套装', '128GB', '冰魄灰', '', '无秒杀', 0, 10000000, '有现货', '「新品热卖，可选+100元得游戏手柄」', '骁龙855 Plus旗舰处理器 / UFS 3.0 高速闪存 / 全系标配12GB大运存 / 液冷3.0+，全域液冷升级 / 电竞级屏幕压感，操作快人一步 / 独显DC调光2.0 护眼全新升级', '黑鲨2 Pro 12GB/128GB+黑鲨双翼左手柄套装');
INSERT INTO `mimi_details_style` (`d_style_id`, `p_name`, `d_style_src`, `d_style_imgs`, `d_style_iconList`, `d_style_installment`, `d_style_promise`, `d_style_price`, `d_style_original_price`, `d_style_MaxCount`, `d_style_model`, `d_style_version`, `p_set_meal`, `d_style_disk`, `d_style_color`, `d_style_size`, `d_style_seckill`, `d_seckill_price`, `d_seckill_time`, `d_style_status`, `d_style_high_title`, `d_style_sub_title`, `p_info`) VALUES
(12, '黑鲨手机2 Pro', 'https://i8.mifile.cn/a1/pms_1564309745.17776332.jpg', '[\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/1e4b88dc3086075195d83eb51e48f515.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/a889720320243aa07ae63963a02ea66e.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/4b1c2f1c0c858d343f3c4bdb96acff43.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/c578bedeedf28b89eaadd19e5eeba969.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/9f622f12af9172bc48c73c599d02bc45.jpg\"\r\n        ]', '[\r\n                {\r\n                    src:\'https://cdn.cnbj0.fds.api.mi-img.com/b2c-mimall-media/f0c04e138bfed2b1ebb589de615236d1.png\',\r\n                    name:\'CPU\',\r\n                    val:\'骁龙855+\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/7692726e7a1dd34a3b1b4ede8aca020d.png\',\r\n                    name:\'双摄像头\',\r\n                    val:\'4800万+1200万像素\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/86a3bd46cf4f7f19daa2c3250cf30604.png\',\r\n                    name:\'超大屏\',\r\n                    val:\'6.39英寸\'\r\n                },      \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/a5ab24dcb527e49f970f13b11e000ab1.png\',\r\n                    name:\'屏幕分辨率\',\r\n                    val:\'2340×1080\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/c8ec0829241324e401744da627482560.png\',\r\n                    name:\'极速畅玩\',\r\n                    val:\'12GB\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/8941adac25333e785b9cc78ca11f4f27.png\',\r\n                    name:\'存储容量\',\r\n                    val:\'256GB\'\r\n                },   \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/0b4ea0fb21dde2f29df3c20de73539b9.png\',\r\n                    name:\'超长待机\',\r\n                    val:\'4000mAh\'\r\n                },    \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/d1b67a407fb2a1ed42c2c0ce15af3318.png\',\r\n                    name:\'运营商网络\',\r\n                    val:\'4G全网通\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/bfd5ba9ae72c365dee42db14dfae4b0f.png\',\r\n                    name:\'网络模式\',\r\n                    val:\'双卡双待\'\r\n                },                                                                       \r\n            ]', '[]', '[\r\n                {\r\n                    name:\"小米自营\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"小米发货\",\r\n                    val:\"由小米发货\"\r\n                },\r\n                {\r\n                    name:\"7天无理由退货\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"\",\r\n                    val:\"由小米发货的商品，单笔满150元免运费;由第三方商家发货的商品，免运费;特殊商品需要单独收取运费，具体以实际结算金额为准；优惠券等不能抵扣运费金额;\"\r\n                }                                                \r\n            ]', 3499, 0, 3, '全网通版', '12GB+256GB', '标配', '256GB', '冰魄灰', '', '无秒杀', 0, 10000000, '有现货', '「新品热卖，可选+100元得游戏手柄」', '骁龙855 Plus旗舰处理器 / UFS 3.0 高速闪存 / 全系标配12GB大运存 / 液冷3.0+，全域液冷升级 / 电竞级屏幕压感，操作快人一步 / 独显DC调光2.0 护眼全新升级', '黑鲨游戏手机2 Pro 12GB+256GB 冰魄灰'),
(13, '黑鲨手机2 Pro', 'https://i8.mifile.cn/a1/pms_1567007329.86589323.jpg', '[\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/1e4b88dc3086075195d83eb51e48f515.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/a889720320243aa07ae63963a02ea66e.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/4b1c2f1c0c858d343f3c4bdb96acff43.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/c578bedeedf28b89eaadd19e5eeba969.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/9f622f12af9172bc48c73c599d02bc45.jpg\"\r\n        ]', '[\r\n                {\r\n                    src:\'https://cdn.cnbj0.fds.api.mi-img.com/b2c-mimall-media/f0c04e138bfed2b1ebb589de615236d1.png\',\r\n                    name:\'CPU\',\r\n                    val:\'骁龙855+\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/7692726e7a1dd34a3b1b4ede8aca020d.png\',\r\n                    name:\'双摄像头\',\r\n                    val:\'4800万+1200万像素\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/86a3bd46cf4f7f19daa2c3250cf30604.png\',\r\n                    name:\'超大屏\',\r\n                    val:\'6.39英寸\'\r\n                },      \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/a5ab24dcb527e49f970f13b11e000ab1.png\',\r\n                    name:\'屏幕分辨率\',\r\n                    val:\'2340×1080\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/c8ec0829241324e401744da627482560.png\',\r\n                    name:\'极速畅玩\',\r\n                    val:\'12GB\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/8941adac25333e785b9cc78ca11f4f27.png\',\r\n                    name:\'存储容量\',\r\n                    val:\'256GB\'\r\n                },   \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/0b4ea0fb21dde2f29df3c20de73539b9.png\',\r\n                    name:\'超长待机\',\r\n                    val:\'4000mAh\'\r\n                },    \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/d1b67a407fb2a1ed42c2c0ce15af3318.png\',\r\n                    name:\'运营商网络\',\r\n                    val:\'4G全网通\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/bfd5ba9ae72c365dee42db14dfae4b0f.png\',\r\n                    name:\'网络模式\',\r\n                    val:\'双卡双待\'\r\n                },                                                                       \r\n            ]', '[]', '[\r\n                {\r\n                    name:\"小米自营\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"小米发货\",\r\n                    val:\"由小米发货\"\r\n                },\r\n                {\r\n                    name:\"7天无理由退货\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"\",\r\n                    val:\"由小米发货的商品，单笔满150元免运费;由第三方商家发货的商品，免运费;特殊商品需要单独收取运费，具体以实际结算金额为准；优惠券等不能抵扣运费金额;\"\r\n                }                                                \r\n            ]', 3618, 0, 3, '全网通版', '12GB+256GB', '+119元得黑鲨双向快充移动电源', '256GB', '冰魄灰', '', '无秒杀', 0, 10000000, '有现货', '「新品热卖，可选+100元得游戏手柄」', '骁龙855 Plus旗舰处理器 / UFS 3.0 高速闪存 / 全系标配12GB大运存 / 液冷3.0+，全域液冷升级 / 电竞级屏幕压感，操作快人一步 / 独显DC调光2.0 护眼全新升级', '黑鲨游戏手机2 Pro 12GB/256GB+黑鲨移动电源套装'),
(14, '黑鲨手机2 Pro', 'https://i8.mifile.cn/a1/pms_1567315640.31439124.jpg', '[\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/1e4b88dc3086075195d83eb51e48f515.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/a889720320243aa07ae63963a02ea66e.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/4b1c2f1c0c858d343f3c4bdb96acff43.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/c578bedeedf28b89eaadd19e5eeba969.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/9f622f12af9172bc48c73c599d02bc45.jpg\"\r\n        ]', '[\r\n                {\r\n                    src:\'https://cdn.cnbj0.fds.api.mi-img.com/b2c-mimall-media/f0c04e138bfed2b1ebb589de615236d1.png\',\r\n                    name:\'CPU\',\r\n                    val:\'骁龙855+\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/7692726e7a1dd34a3b1b4ede8aca020d.png\',\r\n                    name:\'双摄像头\',\r\n                    val:\'4800万+1200万像素\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/86a3bd46cf4f7f19daa2c3250cf30604.png\',\r\n                    name:\'超大屏\',\r\n                    val:\'6.39英寸\'\r\n                },      \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/a5ab24dcb527e49f970f13b11e000ab1.png\',\r\n                    name:\'屏幕分辨率\',\r\n                    val:\'2340×1080\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/c8ec0829241324e401744da627482560.png\',\r\n                    name:\'极速畅玩\',\r\n                    val:\'12GB\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/8941adac25333e785b9cc78ca11f4f27.png\',\r\n                    name:\'存储容量\',\r\n                    val:\'128GB\'\r\n                },   \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/0b4ea0fb21dde2f29df3c20de73539b9.png\',\r\n                    name:\'超长待机\',\r\n                    val:\'4000mAh\'\r\n                },    \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/d1b67a407fb2a1ed42c2c0ce15af3318.png\',\r\n                    name:\'运营商网络\',\r\n                    val:\'4G全网通\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/bfd5ba9ae72c365dee42db14dfae4b0f.png\',\r\n                    name:\'网络模式\',\r\n                    val:\'双卡双待\'\r\n                },                                                                       \r\n            ]', '[]', '[\r\n                {\r\n                    name:\"小米自营\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"小米发货\",\r\n                    val:\"由小米发货\"\r\n                },\r\n                {\r\n                    name:\"7天无理由退货\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"\",\r\n                    val:\"由小米发货的商品，单笔满150元免运费;由第三方商家发货的商品，免运费;特殊商品需要单独收取运费，具体以实际结算金额为准；优惠券等不能抵扣运费金额;\"\r\n                }                                                \r\n            ]', 3599, 0, 3, '全网通版', '12GB+256GB', '+100元得黑鲨左手柄游戏套装', '256GB', '冰魄灰', '', '无秒杀', 0, 10000000, '有现货', '「新品热卖，可选+100元得游戏手柄」', '骁龙855 Plus旗舰处理器 / UFS 3.0 高速闪存 / 全系标配12GB大运存 / 液冷3.0+，全域液冷升级 / 电竞级屏幕压感，操作快人一步 / 独显DC调光2.0 护眼全新升级', '黑鲨2 Pro 12GB/256GB+黑鲨双翼左手柄套装'),
(15, '黑鲨手机2 Pro', 'https://i8.mifile.cn/a1/pms_1564309726.38968606.jpg', '[\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/1e4b88dc3086075195d83eb51e48f515.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/a889720320243aa07ae63963a02ea66e.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/4b1c2f1c0c858d343f3c4bdb96acff43.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/c578bedeedf28b89eaadd19e5eeba969.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/9f622f12af9172bc48c73c599d02bc45.jpg\"\r\n        ]', '[\r\n                {\r\n                    src:\'https://cdn.cnbj0.fds.api.mi-img.com/b2c-mimall-media/f0c04e138bfed2b1ebb589de615236d1.png\',\r\n                    name:\'CPU\',\r\n                    val:\'骁龙855+\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/7692726e7a1dd34a3b1b4ede8aca020d.png\',\r\n                    name:\'双摄像头\',\r\n                    val:\'4800万+1200万像素\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/86a3bd46cf4f7f19daa2c3250cf30604.png\',\r\n                    name:\'超大屏\',\r\n                    val:\'6.39英寸\'\r\n                },      \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/a5ab24dcb527e49f970f13b11e000ab1.png\',\r\n                    name:\'屏幕分辨率\',\r\n                    val:\'2340×1080\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/c8ec0829241324e401744da627482560.png\',\r\n                    name:\'极速畅玩\',\r\n                    val:\'256GB\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/8941adac25333e785b9cc78ca11f4f27.png\',\r\n                    name:\'存储容量\',\r\n                    val:\'128GB\'\r\n                },   \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/0b4ea0fb21dde2f29df3c20de73539b9.png\',\r\n                    name:\'超长待机\',\r\n                    val:\'4000mAh\'\r\n                },    \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/d1b67a407fb2a1ed42c2c0ce15af3318.png\',\r\n                    name:\'运营商网络\',\r\n                    val:\'4G全网通\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/bfd5ba9ae72c365dee42db14dfae4b0f.png\',\r\n                    name:\'网络模式\',\r\n                    val:\'双卡双待\'\r\n                },                                                                       \r\n            ]', '[]', '[\r\n                {\r\n                    name:\"小米自营\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"小米发货\",\r\n                    val:\"由小米发货\"\r\n                },\r\n                {\r\n                    name:\"7天无理由退货\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"\",\r\n                    val:\"由小米发货的商品，单笔满150元免运费;由第三方商家发货的商品，免运费;特殊商品需要单独收取运费，具体以实际结算金额为准；优惠券等不能抵扣运费金额;\"\r\n                }                                                \r\n            ]', 2999, 0, 5, '全网通版', '12GB+128GB', '标配', '128GB', '电鸣黑', '', '无秒杀', 0, 10000000, '有现货', '「新品热卖，可选+100元得游戏手柄」', '骁龙855 Plus旗舰处理器 / UFS 3.0 高速闪存 / 全系标配12GB大运存 / 液冷3.0+，全域液冷升级 / 电竞级屏幕压感，操作快人一步 / 独显DC调光2.0 护眼全新升级', '黑鲨游戏手机2 Pro 12GB+128GB 电鸣黑'),
(16, '黑鲨手机2 Pro', 'https://i8.mifile.cn/a1/pms_1567007329.86589323.jpg', '[\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/1e4b88dc3086075195d83eb51e48f515.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/a889720320243aa07ae63963a02ea66e.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/4b1c2f1c0c858d343f3c4bdb96acff43.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/c578bedeedf28b89eaadd19e5eeba969.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/9f622f12af9172bc48c73c599d02bc45.jpg\"\r\n        ]', '[\r\n                {\r\n                    src:\'https://cdn.cnbj0.fds.api.mi-img.com/b2c-mimall-media/f0c04e138bfed2b1ebb589de615236d1.png\',\r\n                    name:\'CPU\',\r\n                    val:\'骁龙855+\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/7692726e7a1dd34a3b1b4ede8aca020d.png\',\r\n                    name:\'双摄像头\',\r\n                    val:\'4800万+1200万像素\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/86a3bd46cf4f7f19daa2c3250cf30604.png\',\r\n                    name:\'超大屏\',\r\n                    val:\'6.39英寸\'\r\n                },      \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/a5ab24dcb527e49f970f13b11e000ab1.png\',\r\n                    name:\'屏幕分辨率\',\r\n                    val:\'2340×1080\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/c8ec0829241324e401744da627482560.png\',\r\n                    name:\'极速畅玩\',\r\n                    val:\'256GB\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/8941adac25333e785b9cc78ca11f4f27.png\',\r\n                    name:\'存储容量\',\r\n                    val:\'128GB\'\r\n                },   \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/0b4ea0fb21dde2f29df3c20de73539b9.png\',\r\n                    name:\'超长待机\',\r\n                    val:\'4000mAh\'\r\n                },    \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/d1b67a407fb2a1ed42c2c0ce15af3318.png\',\r\n                    name:\'运营商网络\',\r\n                    val:\'4G全网通\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/bfd5ba9ae72c365dee42db14dfae4b0f.png\',\r\n                    name:\'网络模式\',\r\n                    val:\'双卡双待\'\r\n                },                                                                       \r\n            ]', '[]', '[\r\n                {\r\n                    name:\"小米自营\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"小米发货\",\r\n                    val:\"由小米发货\"\r\n                },\r\n                {\r\n                    name:\"7天无理由退货\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"\",\r\n                    val:\"由小米发货的商品，单笔满150元免运费;由第三方商家发货的商品，免运费;特殊商品需要单独收取运费，具体以实际结算金额为准；优惠券等不能抵扣运费金额;\"\r\n                }                                                \r\n            ]', 3118, 0, 5, '全网通版', '12GB+128GB', '+119元得黑鲨双向快充移动电源', '128GB', '电鸣黑', '', '无秒杀', 0, 10000000, '有现货', '「新品热卖，可选+100元得游戏手柄」', '骁龙855 Plus旗舰处理器 / UFS 3.0 高速闪存 / 全系标配12GB大运存 / 液冷3.0+，全域液冷升级 / 电竞级屏幕压感，操作快人一步 / 独显DC调光2.0 护眼全新升级', '黑鲨游戏手机2 Pro 12GB/128GB+黑鲨移动电源套装'),
(17, '黑鲨手机2 Pro', 'https://i8.mifile.cn/a1/pms_1567315640.31439124.jpg', '[\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/1e4b88dc3086075195d83eb51e48f515.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/a889720320243aa07ae63963a02ea66e.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/4b1c2f1c0c858d343f3c4bdb96acff43.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/c578bedeedf28b89eaadd19e5eeba969.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/9f622f12af9172bc48c73c599d02bc45.jpg\"\r\n        ]', '[\r\n                {\r\n                    src:\'https://cdn.cnbj0.fds.api.mi-img.com/b2c-mimall-media/f0c04e138bfed2b1ebb589de615236d1.png\',\r\n                    name:\'CPU\',\r\n                    val:\'骁龙855+\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/7692726e7a1dd34a3b1b4ede8aca020d.png\',\r\n                    name:\'双摄像头\',\r\n                    val:\'4800万+1200万像素\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/86a3bd46cf4f7f19daa2c3250cf30604.png\',\r\n                    name:\'超大屏\',\r\n                    val:\'6.39英寸\'\r\n                },      \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/a5ab24dcb527e49f970f13b11e000ab1.png\',\r\n                    name:\'屏幕分辨率\',\r\n                    val:\'2340×1080\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/c8ec0829241324e401744da627482560.png\',\r\n                    name:\'极速畅玩\',\r\n                    val:\'12GB\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/8941adac25333e785b9cc78ca11f4f27.png\',\r\n                    name:\'存储容量\',\r\n                    val:\'128GB\'\r\n                },   \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/0b4ea0fb21dde2f29df3c20de73539b9.png\',\r\n                    name:\'超长待机\',\r\n                    val:\'4000mAh\'\r\n                },    \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/d1b67a407fb2a1ed42c2c0ce15af3318.png\',\r\n                    name:\'运营商网络\',\r\n                    val:\'4G全网通\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/bfd5ba9ae72c365dee42db14dfae4b0f.png\',\r\n                    name:\'网络模式\',\r\n                    val:\'双卡双待\'\r\n                },                                                                       \r\n            ]', '[]', '[\r\n                {\r\n                    name:\"小米自营\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"小米发货\",\r\n                    val:\"由小米发货\"\r\n                },\r\n                {\r\n                    name:\"7天无理由退货\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"\",\r\n                    val:\"由小米发货的商品，单笔满150元免运费;由第三方商家发货的商品，免运费;特殊商品需要单独收取运费，具体以实际结算金额为准；优惠券等不能抵扣运费金额;\"\r\n                }                                                \r\n            ]', 3099, 0, 5, '全网通版', '12GB+128GB', '+100元得黑鲨左手柄游戏套装', '128GB', '电鸣黑', '', '无秒杀', 0, 10000000, '有现货', '「新品热卖，可选+100元得游戏手柄」', '骁龙855 Plus旗舰处理器 / UFS 3.0 高速闪存 / 全系标配12GB大运存 / 液冷3.0+，全域液冷升级 / 电竞级屏幕压感，操作快人一步 / 独显DC调光2.0 护眼全新升级', '黑鲨2 Pro 12GB/128GB+黑鲨双翼左手柄套装'),
(18, '黑鲨手机2 Pro', 'https://i8.mifile.cn/a1/pms_1564309721.25069397.jpg', '[\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/1e4b88dc3086075195d83eb51e48f515.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/a889720320243aa07ae63963a02ea66e.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/4b1c2f1c0c858d343f3c4bdb96acff43.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/c578bedeedf28b89eaadd19e5eeba969.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/9f622f12af9172bc48c73c599d02bc45.jpg\"\r\n        ]', '[\r\n                {\r\n                    src:\'https://cdn.cnbj0.fds.api.mi-img.com/b2c-mimall-media/f0c04e138bfed2b1ebb589de615236d1.png\',\r\n                    name:\'CPU\',\r\n                    val:\'骁龙855+\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/7692726e7a1dd34a3b1b4ede8aca020d.png\',\r\n                    name:\'双摄像头\',\r\n                    val:\'4800万+1200万像素\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/86a3bd46cf4f7f19daa2c3250cf30604.png\',\r\n                    name:\'超大屏\',\r\n                    val:\'6.39英寸\'\r\n                },      \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/a5ab24dcb527e49f970f13b11e000ab1.png\',\r\n                    name:\'屏幕分辨率\',\r\n                    val:\'2340×1080\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/c8ec0829241324e401744da627482560.png\',\r\n                    name:\'极速畅玩\',\r\n                    val:\'12GB\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/8941adac25333e785b9cc78ca11f4f27.png\',\r\n                    name:\'存储容量\',\r\n                    val:\'256GB\'\r\n                },   \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/0b4ea0fb21dde2f29df3c20de73539b9.png\',\r\n                    name:\'超长待机\',\r\n                    val:\'4000mAh\'\r\n                },    \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/d1b67a407fb2a1ed42c2c0ce15af3318.png\',\r\n                    name:\'运营商网络\',\r\n                    val:\'4G全网通\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/bfd5ba9ae72c365dee42db14dfae4b0f.png\',\r\n                    name:\'网络模式\',\r\n                    val:\'双卡双待\'\r\n                },                                                                       \r\n            ]', '[]', '[\r\n                {\r\n                    name:\"小米自营\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"小米发货\",\r\n                    val:\"由小米发货\"\r\n                },\r\n                {\r\n                    name:\"7天无理由退货\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"\",\r\n                    val:\"由小米发货的商品，单笔满150元免运费;由第三方商家发货的商品，免运费;特殊商品需要单独收取运费，具体以实际结算金额为准；优惠券等不能抵扣运费金额;\"\r\n                }                                                \r\n            ]', 3499, 0, 3, '全网通版', '12GB+256GB', '标配', '256GB', '电鸣黑', '', '无秒杀', 0, 10000000, '有现货', '「新品热卖，可选+100元得游戏手柄」', '骁龙855 Plus旗舰处理器 / UFS 3.0 高速闪存 / 全系标配12GB大运存 / 液冷3.0+，全域液冷升级 / 电竞级屏幕压感，操作快人一步 / 独显DC调光2.0 护眼全新升级', '黑鲨游戏手机2 Pro 12GB+256GB 电鸣黑'),
(19, '黑鲨手机2 Pro', 'https://i8.mifile.cn/a1/pms_1567007374.37121530.jpg', '[\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/1e4b88dc3086075195d83eb51e48f515.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/a889720320243aa07ae63963a02ea66e.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/4b1c2f1c0c858d343f3c4bdb96acff43.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/c578bedeedf28b89eaadd19e5eeba969.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/9f622f12af9172bc48c73c599d02bc45.jpg\"\r\n        ]', '[\r\n                {\r\n                    src:\'https://cdn.cnbj0.fds.api.mi-img.com/b2c-mimall-media/f0c04e138bfed2b1ebb589de615236d1.png\',\r\n                    name:\'CPU\',\r\n                    val:\'骁龙855+\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/7692726e7a1dd34a3b1b4ede8aca020d.png\',\r\n                    name:\'双摄像头\',\r\n                    val:\'4800万+1200万像素\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/86a3bd46cf4f7f19daa2c3250cf30604.png\',\r\n                    name:\'超大屏\',\r\n                    val:\'6.39英寸\'\r\n                },      \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/a5ab24dcb527e49f970f13b11e000ab1.png\',\r\n                    name:\'屏幕分辨率\',\r\n                    val:\'2340×1080\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/c8ec0829241324e401744da627482560.png\',\r\n                    name:\'极速畅玩\',\r\n                    val:\'12GB\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/8941adac25333e785b9cc78ca11f4f27.png\',\r\n                    name:\'存储容量\',\r\n                    val:\'256GB\'\r\n                },   \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/0b4ea0fb21dde2f29df3c20de73539b9.png\',\r\n                    name:\'超长待机\',\r\n                    val:\'4000mAh\'\r\n                },    \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/d1b67a407fb2a1ed42c2c0ce15af3318.png\',\r\n                    name:\'运营商网络\',\r\n                    val:\'4G全网通\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/bfd5ba9ae72c365dee42db14dfae4b0f.png\',\r\n                    name:\'网络模式\',\r\n                    val:\'双卡双待\'\r\n                },                                                                       \r\n            ]', '[]', '[\r\n                {\r\n                    name:\"小米自营\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"小米发货\",\r\n                    val:\"由小米发货\"\r\n                },\r\n                {\r\n                    name:\"7天无理由退货\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"\",\r\n                    val:\"由小米发货的商品，单笔满150元免运费;由第三方商家发货的商品，免运费;特殊商品需要单独收取运费，具体以实际结算金额为准；优惠券等不能抵扣运费金额;\"\r\n                }                                                \r\n            ]', 3618, 0, 3, '全网通版', '12GB+256GB', '+119元得黑鲨双向快充移动电源', '256GB', '电鸣黑', '', '无秒杀', 0, 10000000, '有现货', '「新品热卖，可选+100元得游戏手柄」', '骁龙855 Plus旗舰处理器 / UFS 3.0 高速闪存 / 全系标配12GB大运存 / 液冷3.0+，全域液冷升级 / 电竞级屏幕压感，操作快人一步 / 独显DC调光2.0 护眼全新升级', '黑鲨游戏手机2 Pro 12GB/256GB+黑鲨移动电源套装'),
(20, '黑鲨手机2 Pro', 'https://i8.mifile.cn/a1/pms_1567315679.17736975.jpg', '[\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/1e4b88dc3086075195d83eb51e48f515.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/a889720320243aa07ae63963a02ea66e.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/4b1c2f1c0c858d343f3c4bdb96acff43.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/c578bedeedf28b89eaadd19e5eeba969.jpg\",\r\n            \"https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/9f622f12af9172bc48c73c599d02bc45.jpg\"\r\n        ]', '[\r\n                {\r\n                    src:\'https://cdn.cnbj0.fds.api.mi-img.com/b2c-mimall-media/f0c04e138bfed2b1ebb589de615236d1.png\',\r\n                    name:\'CPU\',\r\n                    val:\'骁龙855+\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/7692726e7a1dd34a3b1b4ede8aca020d.png\',\r\n                    name:\'双摄像头\',\r\n                    val:\'4800万+1200万像素\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/86a3bd46cf4f7f19daa2c3250cf30604.png\',\r\n                    name:\'超大屏\',\r\n                    val:\'6.39英寸\'\r\n                },      \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/a5ab24dcb527e49f970f13b11e000ab1.png\',\r\n                    name:\'屏幕分辨率\',\r\n                    val:\'2340×1080\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/c8ec0829241324e401744da627482560.png\',\r\n                    name:\'极速畅玩\',\r\n                    val:\'256GB\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/8941adac25333e785b9cc78ca11f4f27.png\',\r\n                    name:\'存储容量\',\r\n                    val:\'128GB\'\r\n                },   \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/0b4ea0fb21dde2f29df3c20de73539b9.png\',\r\n                    name:\'超长待机\',\r\n                    val:\'4000mAh\'\r\n                },    \r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/d1b67a407fb2a1ed42c2c0ce15af3318.png\',\r\n                    name:\'运营商网络\',\r\n                    val:\'4G全网通\'\r\n                },\r\n                {\r\n                    src:\'https://i8.mifile.cn/b2c-mimall-media/bfd5ba9ae72c365dee42db14dfae4b0f.png\',\r\n                    name:\'网络模式\',\r\n                    val:\'双卡双待\'\r\n                },                                                                       \r\n            ]', '[]', '[\r\n                {\r\n                    name:\"小米自营\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"小米发货\",\r\n                    val:\"由小米发货\"\r\n                },\r\n                {\r\n                    name:\"7天无理由退货\",\r\n                    val:\"\"\r\n                },\r\n                {\r\n                    name:\"\",\r\n                    val:\"由小米发货的商品，单笔满150元免运费;由第三方商家发货的商品，免运费;特殊商品需要单独收取运费，具体以实际结算金额为准；优惠券等不能抵扣运费金额;\"\r\n                }                                                \r\n            ]', 3599, 0, 3, '全网通版', '12GB+256GB', '+100元得黑鲨左手柄游戏套装', '256GB', '电鸣黑', '', '无秒杀', 0, 10000000, '有现货', '「新品热卖，可选+100元得游戏手柄」', '骁龙855 Plus旗舰处理器 / UFS 3.0 高速闪存 / 全系标配12GB大运存 / 液冷3.0+，全域液冷升级 / 电竞级屏幕压感，操作快人一步 / 独显DC调光2.0 护眼全新升级', '黑鲨2 Pro 12GB/256GB+黑鲨双翼左手柄套装');
...
--
-- 表的结构 `mimi_new_heheight_imglist`
--

CREATE TABLE `mimi_new_heheight_imglist` (
  `d_h_id` int(11) NOT NULL,
  `p_name` varchar(64) NOT NULL,
  `heheight_list` varchar(8192) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- 转存表中的数据 `mimi_new_heheight_imglist`
--

INSERT INTO `mimi_new_heheight_imglist` (`d_h_id`, `p_name`, `heheight_list`) VALUES
...
CREATE TABLE `mimi_product_info` (
  ...
  `pi_set_meal_name` varchar(64) NOT NULL,
...
INSERT INTO `mimi_product_info` (`mimi_pi_id`, `pi_name`, `pi_model`, `pi_version`, `pi_color`, `pi_info`, `pi_set_meal_name`, `pi_set_meal`, `pi_server`, `pi_gift`, `pi_choose`) VALUES
(1, '小米9', '全网通版', '6GB+128GB', '深空灰', '小米9 全网通版 6GB+128GB 深空灰', '标配', '[\r\n                {\r\n                    \"name\":\"小米9 全网通版 6GB+128GB 深空灰\",\r\n                    \"price\":2599,\r\n                    \"original_price\":2999,                                  \r\n                    \"src\":\"https://i8.mifile.cn/a1/pms_1550642167.03594225.jpg\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                         \r\n                }                    \r\n            ]', '[\r\n                {\r\n                    name:\'意外保护\',\r\n                    price:159,\r\n                    count:1,\r\n                    src:\'https://i1.mifile.cn/a1/pms_1550560434.76682404.jpg\',\r\n                    isHas:true,\r\n                    isSelect:false,\r\n                    a_srcIndex:0,\r\n                    b_srcIndex:1,\r\n                    c_srcIndex:2,   \r\n                    values:[\r\n                        {\r\n                            name:\'意外保障服务\',\r\n                            text:\'手机意外碎屏/进水/碾压等损坏\',\r\n                            checked:false,\r\n                            count:1,                    \r\n                            price:299\r\n                        },{\r\n                            name:\'碎屏保障服务\',\r\n                            text:\'手机意外碎屏\',                        \r\n                            checked:false,\r\n                            count:1,                    \r\n                            price:159\r\n                        }\r\n                    ]             \r\n                },\r\n                {\r\n                    name:\'延长保修\',\r\n                    price:99,\r\n                    count:1,\r\n                    src:\'https://i1.mifile.cn/a1/pms_1550560434.76682404.jpg\',                    \r\n                    isHas:true,   \r\n                    isSelect:false,    \r\n                    a_srcIndex:3,\r\n                    b_srcIndex:1,\r\n                    c_srcIndex:2,                                                 \r\n                    values:[\r\n                        {\r\n                            name:\'延长保修服务\',\r\n                            text:\'厂保延一年，性能故障免费维修\',                        \r\n                            checked:false,     \r\n                            count:1,                                   \r\n                            price:99\r\n                        }\r\n                    ]    \r\n                }\r\n            ]', '[]', '[]'),
(2, '小米9', '全网通版', '6GB+128GB', '全息幻彩紫', '小米9 全网通版 6GB+128GB 全息幻彩紫', '标配', '[\r\n                {\r\n                    \"name\":\"小米9 全网通版 6GB+128GB 全息幻彩紫\",\r\n                    \"price\":2599,\r\n                    \"original_price\":2999,                                  \r\n                    \"src\":\"https://i8.mifile.cn/a1/pms_1565339466.57314633.jpg\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                         \r\n                }                    \r\n            ]', '[\r\n                {\r\n                    name:\'意外保护\',\r\n                    price:159,\r\n                    count:1,\r\n                    src:\'https://i1.mifile.cn/a1/pms_1550560434.76682404.jpg\',\r\n                    isHas:true,\r\n                    isSelect:false,\r\n                    a_srcIndex:0,\r\n                    b_srcIndex:1,\r\n                    c_srcIndex:2,   \r\n                    values:[\r\n                        {\r\n                            name:\'意外保障服务\',\r\n                            text:\'手机意外碎屏/进水/碾压等损坏\',\r\n                            checked:false,\r\n                            count:1,                    \r\n                            price:299\r\n                        },{\r\n                            name:\'碎屏保障服务\',\r\n                            text:\'手机意外碎屏\',                        \r\n                            checked:false,\r\n                            count:1,                    \r\n                            price:159\r\n                        }\r\n                    ]             \r\n                },\r\n                {\r\n                    name:\'延长保修\',\r\n                    price:99,\r\n                    count:1,\r\n                    src:\'https://i1.mifile.cn/a1/pms_1550560434.76682404.jpg\',                    \r\n                    isHas:true,   \r\n                    isSelect:false,    \r\n                    a_srcIndex:3,\r\n                    b_srcIndex:1,\r\n                    c_srcIndex:2,                                                 \r\n                    values:[\r\n                        {\r\n                            name:\'延长保修服务\',\r\n                            text:\'厂保延一年，性能故障免费维修\',                        \r\n                            checked:false,     \r\n                            count:1,                                   \r\n                            price:99\r\n                        }\r\n                    ]    \r\n                }\r\n            ]', '[]', '[]'),
(3, '小米9', '全网通版', '6GB+128GB', '全息幻彩蓝', '小米9 全网通版 6GB+128GB 全息幻彩蓝', '标配', '[\r\n                {\r\n                    \"name\":\"小米9 全网通版 6GB+128GB 全息幻彩蓝\",\r\n                    \"price\":2599,\r\n                    \"original_price\":2999,                                  \r\n                    \"src\":\"https://i8.mifile.cn/a1/pms_1550642182.7527088.jpg\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                         \r\n                }                    \r\n            ]', '[\r\n                {\r\n                    name:\'意外保护\',\r\n                    price:159,\r\n                    count:1,\r\n                    src:\'https://i1.mifile.cn/a1/pms_1550560434.76682404.jpg\',\r\n                    isHas:true,\r\n                    isSelect:false,\r\n                    a_srcIndex:0,\r\n                    b_srcIndex:1,\r\n                    c_srcIndex:2,   \r\n                    values:[\r\n                        {\r\n                            name:\'意外保障服务\',\r\n                            text:\'手机意外碎屏/进水/碾压等损坏\',\r\n                            checked:false,\r\n                            count:1,                    \r\n                            price:299\r\n                        },{\r\n                            name:\'碎屏保障服务\',\r\n                            text:\'手机意外碎屏\',                        \r\n                            checked:false,\r\n                            count:1,                    \r\n                            price:159\r\n                        }\r\n                    ]             \r\n                },\r\n                {\r\n                    name:\'延长保修\',\r\n                    price:99,\r\n                    count:1,\r\n                    src:\'https://i1.mifile.cn/a1/pms_1550560434.76682404.jpg\',                    \r\n                    isHas:true,   \r\n                    isSelect:false,    \r\n                    a_srcIndex:3,\r\n                    b_srcIndex:1,\r\n                    c_srcIndex:2,                                                 \r\n                    values:[\r\n                        {\r\n                            name:\'延长保修服务\',\r\n                            text:\'厂保延一年，性能故障免费维修\',                        \r\n                            checked:false,     \r\n                            count:1,                                   \r\n                            price:99\r\n                        }\r\n                    ]    \r\n                }\r\n            ]', '[]', '[]'),
(4, '小米9', '全网通版', '8GB+128GB', '深空灰', '小米9 全网通版 8GB+128GB 深空灰', '标配', '[\r\n                {\r\n                    \"name\":\"小米9 全网通版 8GB+128GB 深空灰\",\r\n                    \"price\":2999,\r\n                    \"original_price\":3299,                                      \r\n                    \"src\":\"https://i8.mifile.cn/a1/pms_1550642167.03594225.jpg\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                         \r\n                }                    \r\n            ]', '[\r\n                {\r\n                    name:\'意外保护\',\r\n                    price:159,\r\n                    count:1,\r\n                    src:\'https://i1.mifile.cn/a1/pms_1550560434.76682404.jpg\',\r\n                    isHas:true,\r\n                    isSelect:false,\r\n                    a_srcIndex:0,\r\n                    b_srcIndex:1,\r\n                    c_srcIndex:2,   \r\n                    values:[\r\n                        {\r\n                            name:\'意外保障服务\',\r\n                            text:\'手机意外碎屏/进水/碾压等损坏\',\r\n                            checked:false,\r\n                            count:1,                    \r\n                            price:299\r\n                        },{\r\n                            name:\'碎屏保障服务\',\r\n                            text:\'手机意外碎屏\',                        \r\n                            checked:false,\r\n                            count:1,                    \r\n                            price:159\r\n                        }\r\n                    ]             \r\n                },\r\n                {\r\n                    name:\'延长保修\',\r\n                    price:99,\r\n                    count:1,\r\n                    src:\'https://i1.mifile.cn/a1/pms_1550560434.76682404.jpg\',                    \r\n                    isHas:true,   \r\n                    isSelect:false,    \r\n                    a_srcIndex:3,\r\n                    b_srcIndex:1,\r\n                    c_srcIndex:2,                                                 \r\n                    values:[\r\n                        {\r\n                            name:\'延长保修服务\',\r\n                            text:\'厂保延一年，性能故障免费维修\',                        \r\n                            checked:false,     \r\n                            count:1,                                   \r\n                            price:99\r\n                        }\r\n                    ]    \r\n                }\r\n            ]', '[]', '[]'),
(5, '小米9', '全网通版', '8GB+128GB', '全息幻彩紫', '小米9 全网通版 8GB+128GB 全息幻彩紫', '标配', '[\r\n                {\r\n                    \"name\":\"小米9 全网通版 8GB+128GB 全息幻彩紫\",\r\n                    \"price\":2999,\r\n                    \"original_price\":3299,                                  \r\n                    \"src\":\"https://i8.mifile.cn/a1/pms_1550642185.33171962.jpg\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                         \r\n                }                    \r\n            ]', '[\r\n                {\r\n                    name:\'意外保护\',\r\n                    price:159,\r\n                    count:1,\r\n                    src:\'https://i1.mifile.cn/a1/pms_1550560434.76682404.jpg\',\r\n                    isHas:true,\r\n                    isSelect:false,\r\n                    a_srcIndex:0,\r\n                    b_srcIndex:1,\r\n                    c_srcIndex:2,   \r\n                    values:[\r\n                        {\r\n                            name:\'意外保障服务\',\r\n                            text:\'手机意外碎屏/进水/碾压等损坏\',\r\n                            checked:false,\r\n                            count:1,                    \r\n                            price:299\r\n                        },{\r\n                            name:\'碎屏保障服务\',\r\n                            text:\'手机意外碎屏\',                        \r\n                            checked:false,\r\n                            count:1,                    \r\n                            price:159\r\n                        }\r\n                    ]             \r\n                },\r\n                {\r\n                    name:\'延长保修\',\r\n                    price:99,\r\n                    count:1,\r\n                    src:\'https://i1.mifile.cn/a1/pms_1550560434.76682404.jpg\',                    \r\n                    isHas:true,   \r\n                    isSelect:false,    \r\n                    a_srcIndex:3,\r\n                    b_srcIndex:1,\r\n                    c_srcIndex:2,                                                 \r\n                    values:[\r\n                        {\r\n                            name:\'延长保修服务\',\r\n                            text:\'厂保延一年，性能故障免费维修\',                        \r\n                            checked:false,     \r\n                            count:1,                                   \r\n                            price:99\r\n                        }\r\n                    ]    \r\n                }\r\n            ]', '[]', '[]'),
(6, '小米9', '全网通版', '8GB+128GB', '全息幻彩蓝', '小米9 全网通版 8GB+128GB 全息幻彩蓝', '标配', '[\r\n                {\r\n                    \"name\":\"小米9 全网通版 8GB+128GB 全息幻彩蓝\",\r\n                    \"price\":3299,\r\n                    \"original_price\":2999,                                  \r\n                    \"src\":\"https://i8.mifile.cn/a1/pms_1550642182.7527088.jpg\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                         \r\n                }                    \r\n            ]', '[\r\n                {\r\n                    name:\'意外保护\',\r\n                    price:159,\r\n                    count:1,\r\n                    src:\'https://i1.mifile.cn/a1/pms_1550560434.76682404.jpg\',\r\n                    isHas:true,\r\n                    isSelect:false,\r\n                    a_srcIndex:0,\r\n                    b_srcIndex:1,\r\n                    c_srcIndex:2,   \r\n                    values:[\r\n                        {\r\n                            name:\'意外保障服务\',\r\n                            text:\'手机意外碎屏/进水/碾压等损坏\',\r\n                            checked:false,\r\n                            count:1,                    \r\n                            price:299\r\n                        },{\r\n                            name:\'碎屏保障服务\',\r\n                            text:\'手机意外碎屏\',                        \r\n                            checked:false,\r\n                            count:1,                    \r\n                            price:159\r\n                        }\r\n                    ]             \r\n                },\r\n                {\r\n                    name:\'延长保修\',\r\n                    price:99,\r\n                    count:1,\r\n                    src:\'https://i1.mifile.cn/a1/pms_1550560434.76682404.jpg\',                    \r\n                    isHas:true,   \r\n                    isSelect:false,    \r\n                    a_srcIndex:3,\r\n                    b_srcIndex:1,\r\n                    c_srcIndex:2,                                                 \r\n                    values:[\r\n                        {\r\n                            name:\'延长保修服务\',\r\n                            text:\'厂保延一年，性能故障免费维修\',                        \r\n                            checked:false,     \r\n                            count:1,                                   \r\n                            price:99\r\n                        }\r\n                    ]    \r\n                }\r\n            ]', '[]', '[]'),
(8, '小米9', '全网通版', '8GB+256GB', '透明版', '小米9 全网通版 8GB+256GB 透明版', '标配', '[\r\n                {\r\n                    \"name\":\"小米9 全网通版 8GB+256GB 透明版\",\r\n                    \"price\":3699,\r\n                    \"original_price\":3699,                                  \r\n                    \"src\":\"https://i8.mifile.cn/a1/pms_1553001921.97126644.jpg\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                         \r\n                }                    \r\n            ]', '[\r\n                {\r\n                    name:\'意外保护\',\r\n                    price:159,\r\n                    count:1,\r\n                    src:\'https://i1.mifile.cn/a1/pms_1550560434.76682404.jpg\',\r\n                    isHas:true,\r\n                    isSelect:false,\r\n                    a_srcIndex:0,\r\n                    b_srcIndex:1,\r\n                    c_srcIndex:2,   \r\n                    values:[\r\n                        {\r\n                            name:\'意外保障服务\',\r\n                            text:\'手机意外碎屏/进水/碾压等损坏\',\r\n                            checked:false,\r\n                            count:1,                    \r\n                            price:299\r\n                        },{\r\n                            name:\'碎屏保障服务\',\r\n                            text:\'手机意外碎屏\',                        \r\n                            checked:false,\r\n                            count:1,                    \r\n                            price:159\r\n                        }\r\n                    ]             \r\n                },\r\n                {\r\n                    name:\'延长保修\',\r\n                    price:99,\r\n                    count:1,\r\n                    src:\'https://i1.mifile.cn/a1/pms_1550560434.76682404.jpg\',                    \r\n                    isHas:true,   \r\n                    isSelect:false,    \r\n                    a_srcIndex:3,\r\n                    b_srcIndex:1,\r\n                    c_srcIndex:2,                                                 \r\n                    values:[\r\n                        {\r\n                            name:\'延长保修服务\',\r\n                            text:\'厂保延一年，性能故障免费维修\',                        \r\n                            checked:false,     \r\n                            count:1,                                   \r\n                            price:99\r\n                        }\r\n                    ]    \r\n                }\r\n            ]', '[      \r\n                {\r\n                    name:\'无线车充或无线充电宝（赠品二选一）\',\r\n                    values:[\r\n                        {\r\n                            \"name\":\"小米无线充电宝10000mAh\",\r\n                            \"price\":0,\r\n                            \"original_price\":149,                            \r\n                            \"src\":\"https://i8.mifile.cn/a1/pms_1550584503.83515033.jpg\",\r\n                            \"color\":\"黑色\",\r\n                            \"count\":1,\r\n                            \"checked\":true\r\n                        },\r\n                        {\r\n                            \"name\":\"小米无线车充\",\r\n                            \"price\":0,\r\n                            \"original_price\":169,                            \r\n                            \"src\":\"https://i1.mifile.cn/a1/pms_1550588698.58663947.jpg\",\r\n                            \"color\":\"黑色\",\r\n                            \"count\":1,\r\n                            \"checked\":false\r\n                        }                          \r\n                    ]\r\n                }               \r\n            ]', '[]'),
(9, '黑鲨手机2 Pro', '全网通版', '12GB+128GB', '冰魄灰', '黑鲨游戏手机2 Pro 12GB+128GB 冰魄灰', '标配', '[\r\n                {\r\n                    \"name\":\"黑鲨游戏手机2 Pro 12GB+128GB 冰魄灰\",\r\n                    \"price\":2999,\r\n                    \"original_price\":2999,                                  \r\n                    \"src\":\"https://i8.mifile.cn/a1/pms_1564309745.17776332.jpg\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                         \r\n                }                    \r\n            ]', '[]', '[]', '[]'),
(10, '黑鲨手机2 Pro', '全网通版', '12GB+128GB', '冰魄灰', '黑鲨游戏手机2 Pro 12GB/128GB+黑鲨移动电源套装', '+119元得黑鲨双向快充移动电源', '[\r\n                {\r\n                    \"name\":\"黑鲨游戏手机2 Pro 12GB/128GB+黑鲨移动电源套装\",\r\n                    \"price\":2999,\r\n                    \"original_price\":2999,                                  \r\n                    \"src\":\"https://i8.mifile.cn/a1/pms_1564309745.17776332.jpg\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                         \r\n                },    \r\n                {\r\n                    \"name\":\"黑鲨双向快充移动电源 黑色\",\r\n                    \"price\":199,\r\n                    \"original_price\":199,                                  \r\n                    \"src\":\"https://i8.mifile.cn/a1/pms_1566870223.32241409.jpg\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                                                            \r\n                }                    \r\n            ]', '[]', '[]', '[]'),
(11, '黑鲨手机2 Pro', '全网通版', '12GB+128GB', '冰魄灰', '黑鲨2 Pro 12GB/128GB+黑鲨双翼左手柄套装', '+100元得黑鲨左手柄游戏套装', '[\r\n                {\r\n                    \"name\":\"黑鲨2 Pro 12GB/128GB+黑鲨双翼左手柄套装\",\r\n                    \"price\":2999,\r\n                    \"original_price\":2999,                                  \r\n                    \"src\":\"https://i8.mifile.cn/a1/pms_1564309745.17776332.jpg\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                         \r\n                },    \r\n                {\r\n                    \"name\":\"黑鲨双翼手柄-左手 黑色\",\r\n                    \"price\":90.1,\r\n                    \"original_price\":179,                                  \r\n                    \"src\":\"https://i8.mifile.cn/a1/pms_1538124791.92791755.jpg\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                                                            \r\n                },    \r\n                {\r\n                    \"name\":\"黑鲨双翼手柄 左手支架 黑色\",\r\n                    \"price\":9.9,\r\n                    \"original_price\":9.9,                                  \r\n                    \"src\":\"https://i8.mifile.cn/v1/a1/b1cea450-4f99-b685-aab2-147e8ce6e31d.webp\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                                                            \r\n                }                   \r\n            ]', '[]', '[]', '[]'),
(12, '黑鲨手机2 Pro', '全网通版', '12GB+256GB', '冰魄灰', '黑鲨游戏手机2 Pro 12GB+256GB 冰魄灰', '标配', '[\r\n                {\r\n                    \"name\":\"黑鲨游戏手机2 Pro 12GB+256GB 冰魄灰\",\r\n                    \"price\":3499,\r\n                    \"original_price\":3499,                                  \r\n                    \"src\":\"https://i8.mifile.cn/a1/pms_1564309745.17776332.jpg\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                         \r\n                }                    \r\n            ]', '[]', '[]', '[]'),
(13, '黑鲨手机2 Pro', '全网通版', '12GB+256GB', '冰魄灰', '黑鲨游戏手机2 Pro 12GB/256GB+黑鲨移动电源套装', '+119元得黑鲨双向快充移动电源', '[\r\n                {\r\n                    \"name\":\"黑鲨游戏手机2 Pro 12GB/256GB+黑鲨移动电源套装\",\r\n                    \"price\":3499,\r\n                    \"original_price\":3499,                                  \r\n                    \"src\":\"https://i8.mifile.cn/a1/pms_1564309745.17776332.jpg\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                         \r\n                },    \r\n                {\r\n                    \"name\":\"黑鲨双向快充移动电源 黑色\",\r\n                    \"price\":199,\r\n                    \"original_price\":199,                                  \r\n                    \"src\":\"https://i8.mifile.cn/a1/pms_1566870223.32241409.jpg\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                                                            \r\n                }                    \r\n            ]', '[]', '[]', '[]'),
(14, '黑鲨手机2 Pro', '全网通版', '12GB+256GB', '冰魄灰', '黑鲨2 Pro 12GB/256GB+黑鲨双翼左手柄套装', '+100元得黑鲨左手柄游戏套装', '[\r\n                {\r\n                    \"name\":\"黑鲨2 Pro 12GB/256GB+黑鲨双翼左手柄套装\",\r\n                    \"price\":3499,\r\n                    \"original_price\":3499,                                  \r\n                    \"src\":\"https://i8.mifile.cn/a1/pms_1564309745.17776332.jpg\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                         \r\n                },    \r\n                {\r\n                    \"name\":\"黑鲨双翼手柄-左手 黑色\",\r\n                    \"price\":90.1,\r\n                    \"original_price\":179,                                  \r\n                    \"src\":\"https://i8.mifile.cn/a1/pms_1538124791.92791755.jpg\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                                                            \r\n                },    \r\n                {\r\n                    \"name\":\"黑鲨双翼手柄 左手支架 黑色\",\r\n                    \"price\":9.9,\r\n                    \"original_price\":9.9,                                  \r\n                    \"src\":\"https://i8.mifile.cn/v1/a1/b1cea450-4f99-b685-aab2-147e8ce6e31d.webp\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                                                            \r\n                }                   \r\n            ]', '[]', '[]', '[]'),
(15, '黑鲨手机2 Pro', '全网通版', '12GB+128GB', '电鸣黑', '黑鲨游戏手机2 Pro 12GB+128GB 电鸣黑', '标配', '[\r\n                {\r\n                    \"name\":\"黑鲨游戏手机2 Pro 12GB+128GB 电鸣黑\",\r\n                    \"price\":2999,\r\n                    \"original_price\":2999,                                  \r\n                    \"src\":\"https://i8.mifile.cn/a1/pms_1564309726.38968606.jpg\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                         \r\n                }                    \r\n            ]', '[]', '[]', '[]'),
(16, '黑鲨手机2 Pro', '全网通版', '12GB+128GB', '电鸣黑', '黑鲨游戏手机2 Pro 12GB/128GB+黑鲨移动电源套装', '+119元得黑鲨双向快充移动电源', '[\r\n                {\r\n                    \"name\":\"黑鲨游戏手机2 Pro 12GB/128GB+黑鲨移动电源套装\",\r\n                    \"price\":2999,\r\n                    \"original_price\":2999,                                  \r\n                    \"src\":\"https://i8.mifile.cn/a1/pms_1564309726.38968606.jpg\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                         \r\n                },    \r\n                {\r\n                    \"name\":\"黑鲨双向快充移动电源 黑色\",\r\n                    \"price\":199,\r\n                    \"original_price\":199,                                  \r\n                    \"src\":\"https://i8.mifile.cn/a1/pms_1566870223.32241409.jpg\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                                                            \r\n                }                    \r\n            ]', '[]', '[]', '[]'),
(17, '黑鲨手机2 Pro', '全网通版', '12GB+128GB', '电鸣黑', '黑鲨2 Pro 12GB/128GB+黑鲨双翼左手柄套装', '+100元得黑鲨左手柄游戏套装', '[\r\n                {\r\n                    \"name\":\"黑鲨2 Pro 12GB/128GB+黑鲨双翼左手柄套装\",\r\n                    \"price\":2999,\r\n                    \"original_price\":2999,                                  \r\n                    \"src\":\"https://i8.mifile.cn/a1/pms_1564309726.38968606.jpg\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                         \r\n                },    \r\n                {\r\n                    \"name\":\"黑鲨双翼手柄-左手 黑色\",\r\n                    \"price\":90.1,\r\n                    \"original_price\":179,                                  \r\n                    \"src\":\"https://i8.mifile.cn/a1/pms_1538124791.92791755.jpg\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                                                            \r\n                },    \r\n                {\r\n                    \"name\":\"黑鲨双翼手柄 左手支架 黑色\",\r\n                    \"price\":9.9,\r\n                    \"original_price\":9.9,                                  \r\n                    \"src\":\"https://i8.mifile.cn/v1/a1/b1cea450-4f99-b685-aab2-147e8ce6e31d.webp\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                                                            \r\n                }                   \r\n            ]', '[]', '[]', '[]'),
(18, '黑鲨手机2 Pro', '全网通版', '12GB+256GB', '电鸣黑', '黑鲨游戏手机2 Pro 12GB+256GB 电鸣黑', '标配', '[\r\n                {\r\n                    \"name\":\"黑鲨游戏手机2 Pro 12GB+256GB 电鸣黑\",\r\n                    \"price\":3499,\r\n                    \"original_price\":3499,                                  \r\n                    \"src\":\"https://i8.mifile.cn/a1/pms_1564309721.25069397.jpg\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                         \r\n                }                    \r\n            ]', '[]', '[]', '[]'),
(19, '黑鲨手机2 Pro', '全网通版', '12GB+256GB', '电鸣黑', '黑鲨游戏手机2 Pro 12GB/256GB+黑鲨移动电源套装', '+119元得黑鲨双向快充移动电源', '[\r\n                {\r\n                    \"name\":\"黑鲨游戏手机2 Pro 12GB/256GB+黑鲨移动电源套装\",\r\n                    \"price\":3499,\r\n                    \"original_price\":3499,                                  \r\n                    \"src\":\"https://i8.mifile.cn/a1/pms_1564309721.25069397.jpg\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                         \r\n                },    \r\n                {\r\n                    \"name\":\"黑鲨双向快充移动电源 黑色\",\r\n                    \"price\":199,\r\n                    \"original_price\":199,                                  \r\n                    \"src\":\"https://i8.mifile.cn/a1/pms_1566870223.32241409.jpg\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                                                            \r\n                }                    \r\n            ]', '[]', '[]', '[]'),
(20, '黑鲨手机2 Pro', '全网通版', '12GB+256GB', '电鸣黑', '黑鲨2 Pro 12GB/256GB+黑鲨双翼左手柄套装', '+100元得黑鲨左手柄游戏套装', '[\r\n                {\r\n                    \"name\":\"黑鲨2 Pro 12GB/256GB+黑鲨双翼左手柄套装\",\r\n                    \"price\":3499,\r\n                    \"original_price\":3499,                                  \r\n                    \"src\":\"https://i8.mifile.cn/a1/pms_1564309721.25069397.jpg\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                         \r\n                },    \r\n                {\r\n                    \"name\":\"黑鲨双翼手柄-左手 黑色\",\r\n                    \"price\":90.1,\r\n                    \"original_price\":179,                                  \r\n                    \"src\":\"https://i8.mifile.cn/a1/pms_1538124791.92791755.jpg\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                                                            \r\n                },    \r\n                {\r\n                    \"name\":\"黑鲨双翼手柄 左手支架 黑色\",\r\n                    \"price\":9.9,\r\n                    \"original_price\":9.9,                                  \r\n                    \"src\":\"https://i8.mifile.cn/v1/a1/b1cea450-4f99-b685-aab2-147e8ce6e31d.webp\",\r\n                    \"count\":1,\r\n                    \"index\":0,                            \r\n                    \"checked\":true,\r\n                    \"valList\":[]                                                            \r\n                }                   \r\n            ]', '[]', '[]', '[]');
...
CREATE TABLE `mimi_product_overview` (
  ...
  `p_info` varchar(128) CHARACTER SET utf8 NOT NULL,
  `p_set_meal` varchar(64) CHARACTER SET ucs2 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `mimi_product_overview` (`p_id`, `p_name`, `p_title`, `p_price`, `p_originalPrice`, `p_src`, `p_type`, `img_type`, `style_type`, `img_style`, `p_index`, `p_line`, `data_type`, `p_info`, `p_set_meal`) VALUES
(1, '新品发布', '', 0, 0, 'http://www.zlpones.com/imgs/mi/img/', '综合', '.webp', 'style_b', 'width:75px;height:79px;background:#bbb;', 1, 'aaa', 'multi-', '黑鲨游戏手机2 Pro 12GB+128GB 电鸣黑', '标配'),
...
(22, '小米9', '全息幻彩机身，骁龙855', 2999, 0, 'http://www.zlpones.com/imgs/mi/img/', '综合', '.webp', 'style_e', 'width:179px;height:145.8px;background:#eee;', 9, 'ccc', 'sole', '小米9 全网通版 6GB+128GB 全息幻彩紫', '标配'),
...
INSERT INTO `mimi_shopping_info` (`mimi_si_id`, `si_info`, `si_only`, `si_set_meal`, `si_server`, `si_gift`, `si_choose`, `si_count`, `si_checked`) VALUES
(140, '小米9 全网通版 6GB+128GB 全息幻彩紫', '{\"p_name\":\"小米9\",\"d_style_src\":\"https://i8.mifile.cn/a1/pms_1550642185.33171962.jpg\",\"d_style_version\":\"6GB+128GB\",\"d_style_disk\":\"128GB\",\"d_style_color\":\"全息幻彩紫\",\"d_style_price\":\"2599\",\"d_style_original_price\":\"2999\",\"d_style_MaxCount\":\"4\"}', '[{\"name\":\"标配\",\"values\":[{\"name\":\"小米9全网通版6GB+128GB\",\"price\":2599,\"original_price\":2999,\"src\":\"https://i8.mifile.cn/a1/pms_1565339466.57314633.jpg\",\"color\":\"全息幻彩紫\",\"count\":1,\"checked\":true}]}]', '[{\"name\":\"意外保护\",\"price\":159,\"count\":1,\"src\":\"https://i1.mifile.cn/a1/pms_1550560434.76682404.jpg\",\"isHas\":true,\"isSelect\":false,\"a_srcIndex\":0,\"b_srcIndex\":1,\"c_srcIndex\":2,\"values\":[{\"name\":\"意外保障服务\",\"text\":\"手机意外碎屏/进水/碾压等损坏\",\"checked\":false,\"count\":1,\"price\":299},{\"name\":\"碎屏保障服务\",\"text\":\"手机意外碎屏\",\"checked\":false,\"count\":1,\"price\":159}]},{\"name\":\"延长保修\",\"price\":99,\"count\":1,\"src\":\"https://i1.mifile.cn/a1/pms_1550560434.76682404.jpg\",\"isHas\":true,\"isSelect\":false,\"a_srcIndex\":3,\"b_srcIndex\":1,\"c_srcIndex\":2,\"values\":[{\"name\":\"延长保修服务\",\"text\":\"厂保延一年，性能故障免费维修\",\"checked\":false,\"count\":1,\"price\":99}]}]', '[]', '[]', 4, 1),
(141, '小米9 全网通版 8GB+128GB 全息幻彩紫', '{\"p_name\":\"小米9\",\"d_style_src\":\"https://i8.mifile.cn/a1/pms_1550642185.33171962.jpg\",\"d_style_version\":\"8GB+128GB\",\"d_style_disk\":\"128GB\",\"d_style_color\":\"全息幻彩紫\",\"d_style_price\":\"2999\",\"d_style_original_price\":\"3299\",\"d_style_MaxCount\":\"3\"}', '[{\"name\":\"标配\",\"values\":[{\"name\":\"小米9全网通版8GB+128GB\",\"price\":2999,\"original_price\":3299,\"src\":\"https://i8.mifile.cn/a1/pms_1565339466.57314633.jpg\",\"color\":\"全息幻彩紫\",\"count\":1,\"checked\":true}]}]', '[{\"name\":\"意外保护\",\"price\":159,\"count\":1,\"src\":\"https://i1.mifile.cn/a1/pms_1550560434.76682404.jpg\",\"isHas\":true,\"isSelect\":false,\"a_srcIndex\":0,\"b_srcIndex\":1,\"c_srcIndex\":2,\"values\":[{\"name\":\"意外保障服务\",\"text\":\"手机意外碎屏/进水/碾压等损坏\",\"checked\":false,\"count\":1,\"price\":299},{\"name\":\"碎屏保障服务\",\"text\":\"手机意外碎屏\",\"checked\":false,\"count\":1,\"price\":159}]},{\"name\":\"延长保修\",\"price\":99,\"count\":1,\"src\":\"https://i1.mifile.cn/a1/pms_1550560434.76682404.jpg\",\"isHas\":true,\"isSelect\":false,\"a_srcIndex\":3,\"b_srcIndex\":1,\"c_srcIndex\":2,\"values\":[{\"name\":\"延长保修服务\",\"text\":\"厂保延一年，性能故障免费维修\",\"checked\":false,\"count\":1,\"price\":99}]}]', '[]', '[]', 3, 1),
(142, '小米9 全网通版 8GB+256GB 透明版', '{\"p_name\":\"小米9\",\"d_style_src\":\"https://i8.mifile.cn/a1/pms_1553001921.97126644.jpg\",\"d_style_version\":\"8GB+256GB\",\"d_style_disk\":\"256GB\",\"d_style_color\":\"透明版\",\"d_style_price\":\"3699\",\"d_style_original_price\":\"0\",\"d_style_MaxCount\":\"2\"}', '[{\"name\":\"标配\",\"values\":[{\"name\":\"小米9全网通版8GB+256GB\",\"price\":3699,\"original_price\":0,\"src\":\"https://i1.mifile.cn/a1/pms_1553001921.97126644.jpg\",\"color\":\"透明\",\"count\":1,\"checked\":true}]}]', '[{\"name\":\"意外保护\",\"price\":159,\"count\":1,\"src\":\"https://i1.mifile.cn/a1/pms_1550560434.76682404.jpg\",\"isHas\":true,\"isSelect\":false,\"a_srcIndex\":0,\"b_srcIndex\":1,\"c_srcIndex\":2,\"values\":[{\"name\":\"意外保障服务\",\"text\":\"手机意外碎屏/进水/碾压等损坏\",\"checked\":false,\"count\":1,\"price\":299},{\"name\":\"碎屏保障服务\",\"text\":\"手机意外碎屏\",\"checked\":false,\"count\":1,\"price\":159}]},{\"name\":\"延长保修\",\"price\":99,\"count\":1,\"src\":\"https://i1.mifile.cn/a1/pms_1550560434.76682404.jpg\",\"isHas\":true,\"isSelect\":false,\"a_srcIndex\":3,\"b_srcIndex\":1,\"c_srcIndex\":2,\"values\":[{\"name\":\"延长保修服务\",\"text\":\"厂保延一年，性能故障免费维修\",\"checked\":false,\"count\":1,\"price\":99}]}]', '[{\"name\":\"无线车充或无线充电宝（赠品二选一）\",\"values\":[{\"name\":\"小米无线充电宝10000mAh\",\"price\":0,\"original_price\":149,\"src\":\"https://i8.mifile.cn/a1/pms_1550584503.83515033.jpg\",\"color\":\"黑色\",\"count\":1,\"checked\":true},{\"name\":\"小米无线车充\",\"price\":0,\"original_price\":169,\"src\":\"https://i1.mifile.cn/a1/pms_1550588698.58663947.jpg\",\"color\":\"黑色\",\"count\":1,\"checked\":false}]}]', '[]', 2, 1),
(143, '小米9 全网通版 8GB+128GB 深空灰', '{\"p_name\":\"小米9\",\"d_style_src\":\"https://i8.mifile.cn/a1/pms_1550642167.03594225.jpg\",\"d_style_version\":\"8GB+128GB\",\"d_style_disk\":\"128GB\",\"d_style_color\":\"深空灰\",\"d_style_price\":\"2999\",\"d_style_original_price\":\"3299\",\"d_style_MaxCount\":\"3\"}', '[{\"name\":\"标配\",\"values\":[{\"name\":\"小米9全网通版8GB+128GB\",\"price\":2999,\"original_price\":3299,\"src\":\"https://i8.mifile.cn/a1/pms_1565339450.93196576.jpg\",\"color\":\"深空灰\",\"count\":1,\"checked\":true}]}]', '[{\"name\":\"意外保护\",\"price\":159,\"count\":1,\"src\":\"https://i1.mifile.cn/a1/pms_1550560434.76682404.jpg\",\"isHas\":true,\"isSelect\":false,\"a_srcIndex\":0,\"b_srcIndex\":1,\"c_srcIndex\":2,\"values\":[{\"name\":\"意外保障服务\",\"text\":\"手机意外碎屏/进水/碾压等损坏\",\"checked\":false,\"count\":1,\"price\":299},{\"name\":\"碎屏保障服务\",\"text\":\"手机意外碎屏\",\"checked\":false,\"count\":1,\"price\":159}]},{\"name\":\"延长保修\",\"price\":99,\"count\":1,\"src\":\"https://i1.mifile.cn/a1/pms_1550560434.76682404.jpg\",\"isHas\":true,\"isSelect\":false,\"a_srcIndex\":3,\"b_srcIndex\":1,\"c_srcIndex\":2,\"values\":[{\"name\":\"延长保修服务\",\"text\":\"厂保延一年，性能故障免费维修\",\"checked\":false,\"count\":1,\"price\":99}]}]', '[]', '[]', 3, 1),
(144, '小米9 全网通版 6GB+128GB 全息幻彩蓝', '{\"p_name\":\"小米9\",\"d_style_src\":\"https://i8.mifile.cn/a1/pms_1550642182.7527088.jpg\",\"d_style_version\":\"6GB+128GB\",\"d_style_disk\":\"128GB\",\"d_style_color\":\"全息幻彩蓝\",\"d_style_price\":\"2599\",\"d_style_original_price\":\"2999\",\"d_style_MaxCount\":\"4\"}', '[{\"name\":\"标配\",\"values\":[{\"name\":\"小米9全网通版6GB+128GB\",\"price\":2599,\"original_price\":2999,\"src\":\"https://i8.mifile.cn/a1/pms_1550642240.48638886.jpg\",\"color\":\"全息幻彩蓝\",\"count\":1,\"checked\":true}]}]', '[{\"name\":\"意外保护\",\"price\":159,\"count\":1,\"src\":\"https://i1.mifile.cn/a1/pms_1550560434.76682404.jpg\",\"isHas\":true,\"isSelect\":true,\"a_srcIndex\":0,\"b_srcIndex\":1,\"c_srcIndex\":2,\"values\":[{\"name\":\"意外保障服务\",\"text\":\"手机意外碎屏/进水/碾压等损坏\",\"checked\":false,\"count\":1,\"price\":299},{\"name\":\"碎屏保障服务\",\"text\":\"手机意外碎屏\",\"checked\":true,\"count\":1,\"price\":159}]},{\"name\":\"延长保修\",\"price\":99,\"count\":1,\"src\":\"https://i1.mifile.cn/a1/pms_1550560434.76682404.jpg\",\"isHas\":true,\"isSelect\":true,\"a_srcIndex\":3,\"b_srcIndex\":1,\"c_srcIndex\":2,\"values\":[{\"name\":\"延长保修服务\",\"text\":\"厂保延一年，性能故障免费维修\",\"checked\":true,\"count\":1,\"price\":99}]}]', '[]', '[]', 3, 1),
(145, '小米9 全网通版 8GB+128GB 全息幻彩蓝', '{\"p_name\":\"小米9\",\"d_style_src\":\"https://i8.mifile.cn/a1/pms_1550642182.7527088.jpg\",\"d_style_version\":\"8GB+128GB\",\"d_style_disk\":\"128GB\",\"d_style_color\":\"全息幻彩蓝\",\"d_style_price\":\"2999\",\"d_style_original_price\":\"3299\",\"d_style_MaxCount\":\"3\"}', '[{\"name\":\"标配\",\"values\":[{\"name\":\"小米9全网通版8GB+128GB\",\"price\":2999,\"original_price\":3299,\"src\":\"https://i8.mifile.cn/a1/pms_1550642240.48638886.jpg\",\"color\":\"全息幻彩蓝\",\"count\":1,\"checked\":true}]}]', '[{\"name\":\"意外保护\",\"price\":159,\"count\":1,\"src\":\"https://i1.mifile.cn/a1/pms_1550560434.76682404.jpg\",\"isHas\":true,\"isSelect\":false,\"a_srcIndex\":0,\"b_srcIndex\":1,\"c_srcIndex\":2,\"values\":[{\"name\":\"意外保障服务\",\"text\":\"手机意外碎屏/进水/碾压等损坏\",\"checked\":false,\"count\":1,\"price\":299},{\"name\":\"碎屏保障服务\",\"text\":\"手机意外碎屏\",\"checked\":false,\"count\":1,\"price\":159}]},{\"name\":\"延长保修\",\"price\":99,\"count\":1,\"src\":\"https://i1.mifile.cn/a1/pms_1550560434.76682404.jpg\",\"isHas\":true,\"isSelect\":false,\"a_srcIndex\":3,\"b_srcIndex\":1,\"c_srcIndex\":2,\"values\":[{\"name\":\"延长保修服务\",\"text\":\"厂保延一年，性能故障免费维修\",\"checked\":false,\"count\":1,\"price\":99}]}]', '[]', '[]', 2, 1);
...
--
-- 表的索引 `mimi_new_heheight_imglist`
--
ALTER TABLE `mimi_new_heheight_imglist`
  ADD UNIQUE KEY `d_h_id` (`d_h_id`);
...
--
-- 使用表AUTO_INCREMENT `mimi_details_style`
--
ALTER TABLE `mimi_details_style`
  MODIFY `d_style_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
-- 使用表AUTO_INCREMENT `mimi_new_heheight_imglist`
--
ALTER TABLE `mimi_new_heheight_imglist`
  MODIFY `d_h_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `mimi_product_info`
  MODIFY `mimi_pi_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- 使用表AUTO_INCREMENT `mimi_shopping_info`
--
ALTER TABLE `mimi_shopping_info`
  MODIFY `mimi_si_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=146;
COMMIT;
